...
DATA["A terrified cat has survived a five-mile round trip under the engine cover of a car on a school run."] = {
    "connected_speech": [
        ...
        {"words": "cover of a car", "phonetic": "/ˈkʌvər əv ə kɑːr/", "description": "cover结尾的/r/与of开头的/ə/发生r连读（辅元连读）；of弱读为/əv/，结尾的/v/与a的/ə/发生辅元连读；a的/ə/与car开头的/k/发生辅元连读。"},
        {"words": "on a school run", "phonetic": "/ɒn ə skuːl rʌn/", "description": "on结尾的/n/与a的/ə/发生辅元连读；a的/ə/与school开头的/s/发生辅元连读；school结尾的/l/与run开头的/r/发生辅音连读。"},
    ],
    "sense_groups": {
...
DATA["The black cat was found curled up under the engine cover of David King's car when he decided to do an oil check after dropping his grandson off at school."] = {
    "connected_speech": [
        ...
        {"words": "was found curled up", "phonetic": "/wəz faʊnd kɜːld ʌp/", "description": "was弱读为/wəz/，结尾的/z/与found开头的/f/发生辅音连读；found结尾的/d/与curled开头的/k/相邻，发生不完全爆破；curled结尾的/d/与up开头的/ʌ/发生辅元连读。"},
        ...
        {"words": "of David King's car", "phonetic": "/əv ˈdeɪvɪd kɪŋz kɑːr/", "description": "of弱读为/əv/，结尾的/v/与David开头的/d/发生辅音连读；David结尾的/d/与King's开头的/k/相邻，发生不完全爆破；King's结尾的/z/与car开头的/k/发生辅音连读。"},
        ...
        {"words": "after dropping his grandson off at school", "phonetic": "/ˈɑːftər ˈdrɒpɪŋ hɪz ˈɡrænsʌn ɒf ət skuːl/", "description": "after结尾的/r/与dropping开头的/d/发生辅元连读（r连读）；dropping结尾的/ŋ/与his开头的/h/发生辅元连读；his结尾的/z/与grandson开头的/ɡ/发生辅音连读；off结尾的/f/与at开头的/ə/发生辅元连读；at弱读为/ət/，与school开头的/s/发生辅元连读。"},
    ],
    "sense_groups": {
...
DATA["We weren't even sure it was alive, so I gently pushed it with a stick to check it was breathing and saw it was a terrified little cat."] = {
    "connected_speech": [
        {"words": "We weren't even sure", "phonetic": "/wi wɜːnt ˈiːvən ʃʊər/", "description": "weren't结尾的/t/与even开头的/iː/发生辅元连读；even结尾的/n/与sure开头的/ʃ/发生辅元连读；sure结尾的/r/在英式发音中不发音，在美式中可与后续元音发生r连读。"},
        ...
        {"words": "to check it was breathing", "phonetic": "/tə tʃek ɪt wəz ˈbriːðɪŋ/", "description": "to弱读为/tə/，与check开头的/tʃ/发生辅元连读；check结尾的/k/与it开头的/ɪ/发生辅元连读；it结尾的/t/与was开头的/w/相邻，发生不完全爆破；was弱读为/wəz/。"},
        {"words": "and saw it was", "phonetic": "/ən sɔː ɪt wəz/", "description": "and弱读为/ən/，结尾的/d/省略，/n/与saw开头的/s/发生辅元连读；saw结尾的元音/ɔː/与it开头的/ɪ/发生元元连读；it结尾的/t/与was开头的/w/相邻，发生不完全爆破。"},
...
DATA["Following a rescue by UK charity Cats Protection, the four year old cat was later reunited with its owner, Mr King's neighbour."] = {
    "connected_speech": [
        {"words": "Following a rescue", "phonetic": "/ˈfɒləʊɪŋ ə ˈreskjuː/", "description": "Following结尾的/ŋ/与a的/ə/发生辅元连读；a的/ə/与rescue开头的/r/发生辅元连读。"},
        {"words": "by UK charity", "phonetic": "/baɪ juːˈkeɪ ˈtʃærɪti/", "description": "by结尾的/aɪ/与UK开头的/juː/发生元元连读（加/j/过渡音）；UK结尾的/eɪ/与charity开头的/tʃ/发生元辅连读。"},
        {"words": "Cats Protection", "phonetic": "/kæts prəˈtekʃən/", "description": "Cats结尾的/s/与Protection开头的/p/发生辅音连读，/s/可略微延长。"},
        {"words": "the four year old cat", "phonetic": "/ðə fɔːr jɪər əʊld kæt/", "description": "the弱读为/ðə/，与four开头的/f/发生辅元连读；four结尾的/r/与year开头的/j/发生r连读；year结尾的/r/与old开头的/əʊ/发生r连读；old结尾的/d/与cat开头的/k/相邻，发生不完全爆破。"},
        {"words": "was later reunited", "phonetic": "/wəz ˈleɪtər ˌriːjuːˈnaɪtɪd/", "description": "was弱读为/wəz/，结尾的/z/与later开头的/l/发生辅元连读；later结尾的/r/与reunited开头的/r/发生辅音连读，可合并或轻微延长。"},
        {"words": "with its owner", "phonetic": "/wɪð ɪts ˈəʊnər/", "description": "with结尾的/ð/与its开头的/ɪ/发生辅元连读；its结尾的/s/与owner开头的/əʊ/发生辅元连读。"},
    ],
    "sense_groups": {
...
DATA["In less than a month, the Special Olympics Spring Games will make a return to Fayetteville for the first time in five years."] = {
    "connected_speech": [
        ...
        {"words": "will make a return", "phonetic": "/wɪl meɪk ə rɪˈtɜːn/", "description": "will结尾的/l/与make开头的/m/发生辅音连读；make结尾的/k/与a的/ə/发生辅元连读；a的/ə/与return开头的/r/发生辅元连读。"},
        {"words": "to Fayetteville", "phonetic": "/tə ˈfeɪɛtvɪl/", "description": "to弱读为/tə/，与Fayetteville开头的/f/发生辅元连读。"},
        {"words": "for the first time in five years", "phonetic": "/fər ðə fɜːst taɪm ɪn faɪv jɪərz/", "description": "for弱读为/fər/，结尾的/r/与the开头的/ð/发生辅音连读；the弱读为/ðə/；first结尾的/t/与time开头的/t/相邻，发生不完全爆破；time结尾的/m/与in开头的/ɪ/发生辅元连读；five结尾的/v/与years开头的/j/发生辅元连读。"},
    ],
    "sense_groups": {
...
DATA["Event organizer Benjamin Koalzick says he's excited that athletes will get a chance to come back and demonstrate their abilities."] = {
    "connected_speech": [
        {"words": "Event organizer", "phonetic": "/ɪˈvent ˈɔːɡənaɪzər/", "description": "Event结尾的/t/与organizer开头的/ɔː/发生辅元连读。"},
        {"words": "Benjamin Koalzick says", "phonetic": "/ˈbendʒəmɪn ˈkəʊlzɪk sez/", "description": "Benjamin结尾的/n/与Koalzick开头的/k/发生辅元连读；Koalzick结尾的/k/与says开头的/s/发生辅音连读。"},
        ...
        {"words": "athletes will get a chance", "phonetic": "/ˈæθliːts wɪl ɡet ə tʃɑːns/", "description": "athletes结尾的/s/与will开头的/w/发生辅音连读；will结尾的/l/与get开头的/ɡ/发生辅音连读；get结尾的/t/与a的/ə/发生辅元连读；a的/ə/与chance开头的/tʃ/发生辅元连读。"},
        ...
        {"words": "demonstrate their abilities", "phonetic": "/ˈdemənstreɪt ðeər əˈbɪlɪtiz/", "description": "demonstrate结尾的/t/与their开头的/ð/相邻，发生不完全爆破；their结尾的/r/与abilities开头的/ə/发生r连读。"},
    ],
    "sense_groups": {
...
DATA["Organizers expect about one hundred athletes will come out to compete in a variety of events including running, throwing, and jumping."] = {
    "connected_speech": [
        {"words": "Organizers expect about", "phonetic": "/ˈɔːɡənaɪzərz ɪkˈspekt əˈbaʊt/", "description": "Organizers结尾的/z/与expect开头的/ɪ/发生辅元连读；expect结尾的/t/与about开头的/ə/发生辅元连读；about弱读为/əˈbaʊt/。"},
        {"words": "one hundred athletes", "phonetic": "/wʌn ˈhʌndrəd ˈæθliːts/", "description": "one结尾的/n/与hundred开头的/h/发生辅元连读（h可弱读）；hundred结尾的/d/与athletes开头的/æ/发生辅元连读。"},
        {"words": "will come out", "phonetic": "/wɪl kʌm aʊt/", "description": "will结尾的/l/与come开头的/k/发生辅音连读；come结尾的/m/与out开头的/aʊ/发生辅元连读。"},
        {"words": "to compete in a variety of events", "phonetic": "/tə kəmˈpiːt ɪn ə vəˈraɪəti əv ɪˈvents/", "description": "to弱读为/tə/，与compete开头的/k/发生辅元连读；compete结尾的/t/与in开头的/ɪ/发生辅元连读；in结尾的/n/与a的/ə/发生辅元连读；variety结尾的/i/与of开头的/ə/发生元元连读；of弱读为/əv/，结尾的/v/与events开头的/ɪ/发生辅元连读。"},
        {"words": "including running, throwing, and jumping", "phonetic": "/ɪnˈkluːdɪŋ ˈrʌnɪŋ ˈθrəʊɪŋ ən ˈdʒʌmpɪŋ/", "description": "including结尾的/ŋ/与running开头的/r/发生辅元连读；running结尾的/ŋ/与throwing开头的/θ/发生辅元连读；throwing结尾的/ŋ/与and的/ən/发生辅元连读；and弱读为/ən/，结尾的/n/与jumping开头的/dʒ/发生辅元连读。"},
    ],
    "sense_groups": {
...
DATA["Kawalski said it's rewarding to see athletes with special needs triumph in the games."] = {
    "connected_speech": [
        {"words": "Kawalski said it's", "phonetic": "/ˈkəʊlzɪk sed ɪts/", "description": "Kawalski结尾的/i/与said开头的/s/发生辅元连读；said结尾的/d/与it's开头的/ɪ/发生辅元连读；it's结尾的/s/与后续rewarding开头的/r/发生辅音连读。"},
        {"words": "rewarding to see", "phonetic": "/rɪˈwɔːdɪŋ tə siː/", "description": "rewarding结尾的/ŋ/与to开头的/t/发生辅元连读；to弱读为/tə/，结尾的/ə/与see开头的/s/发生辅元连读。"},
        {"words": "athletes with special needs", "phonetic": "/ˈæθliːts wɪð ˈspeʃəl niːdz/", "description": "athletes结尾的/s/与with开头的/w/发生辅音连读；with结尾的/ð/与special开头的/s/发生辅音连读；special结尾的/l/与needs开头的/n/发生辅音连读。"},
        {"words": "triumph in the games", "phonetic": "/ˈtraɪəmf ɪn ðə ɡeɪmz/", "description": "triumph结尾的/f/与in开头的/ɪ/发生辅元连读；in结尾的/n/与the的/ðə/发生辅元连读；the弱读为/ðə/，与games开头的/ɡ/发生辅元连读。"},
    ],
    "sense_groups": {
...
DATA["A German supermarket has been ordered to destroy its chocolate rabbits after losing a court battle with a Swiss chocolate manufacturer."] = {
    "connected_speech": [
        {"words": "A German supermarket", "phonetic": "/ə ˈdʒɜːmən ˈsuːpəmɑːkɪt/", "description": "A弱读为/ə/，与German开头的/dʒ/发生辅元连读；German结尾的/n/与supermarket开头的/s/发生辅元连读。"},
        {"words": "has been ordered to", "phonetic": "/həz biːn ˈɔːdəd tə/", "description": "has弱读为/həz/，结尾的/z/与been开头的/b/发生辅音连读；been结尾的/n/与ordered开头的/ɔː/发生辅元连读；ordered结尾的/d/与to开头的/t/相邻，发生不完全爆破；to弱读为/tə/。"},
        {"words": "destroy its chocolate rabbits", "phonetic": "/dɪˈstrɔɪ ɪts ˈtʃɒklət ˈræbɪts/", "description": "destroy结尾的/ɔɪ/与its开头的/ɪ/发生元元连读；its结尾的/s/与chocolate开头的/tʃ/发生辅音连读；chocolate结尾的/t/与rabbits开头的/r/发生辅元连读。"},
        {"words": "after losing a court battle", "phonetic": "/ˈɑːftər ˈluːzɪŋ ə kɔːt ˈbætəl/", "description": "after结尾的/r/与losing开头的/l/发生辅元连读(r连读)；losing结尾的/ŋ/与a的/ə/发生辅元连读；court结尾的/t/与battle开头的/b/相邻，发生不完全爆破（失爆）。"},
        {"words": "with a Swiss chocolate manufacturer", "phonetic": "/wɪð ə swɪs ˈtʃɒklət ˌmænjuˈfæktʃərər/", "description": "with结尾的/ð/与a的/ə/发生辅元连读；a的/ə/与Swiss开头的/s/发生辅元连读；Swiss结尾的/s/与chocolate开头的/tʃ/发生辅音连读；chocolate结尾的/t/与manufacturer开头的/m/相邻，发生不完全爆破。"},
    ],
    "sense_groups": {
...
DATA["The Swiss firm had argued its gold wrapped chocolate rabbit deserved copyright protection from a similar product sold by the budget supermarket."] = {
    "connected_speech": [
        {"words": "The Swiss firm had argued", "phonetic": "/ðə swɪs fɜːm həd ˈɑːɡjuːd/", "description": "the弱读为/ðə/，与Swiss开头的/s/发生辅元连读；Swiss结尾的/s/与firm开头的/f/发生辅音连读；had弱读为/həd/，结尾的/d/与argued开头的/ɑː/发生辅元连读。"},
        {"words": "its gold wrapped chocolate rabbit", "phonetic": "/ɪts ɡəʊld ræpt ˈtʃɒklət ˈræbɪt/", "description": "its结尾的/s/与gold开头的/ɡ/发生辅音连读；gold结尾的/d/与wrapped开头的/r/发生辅元连读；wrapped结尾的/t/与chocolate开头的/tʃ/相邻，发生不完全爆破；chocolate结尾的/t/与rabbit开头的/r/发生辅元连读。"},
        {"words": "deserved copyright protection", "phonetic": "/dɪˈzɜːvd ˈkɒpiraɪt prəˈtekʃən/", "description": "deserved结尾的/d/与copyright开头的/k/相邻，发生不完全爆破（失爆）；copyright结尾的/t/与protection开头的/p/相邻，发生不完全爆破。"},
        {"words": "from a similar product", "phonetic": "/frəm ə ˈsɪmɪlər ˈprɒdʌkt/", "description": "from弱读为/frəm/，结尾的/m/与a的/ə/发生辅元连读；similar结尾的/r/与product开头的/p/发生辅元连读（r连读）。"},
        {"words": "sold by the budget supermarket", "phonetic": "/səʊld baɪ ðə ˈbʌdʒɪt ˈsuːpəmɑːkɪt/", "description": "sold结尾的/d/与by开头的/b/相邻，发生不完全爆破；by结尾的/aɪ/与the的/ðə/发生元元连读；budget结尾的/t/与supermarket开头的/s/相邻，发生不完全爆破。"},
    ],
    "sense_groups": {
...
DATA["Switzerland's highest court agreed and overturned a ruling last year that had sided with the supermarket."] = {
    "connected_speech": [
        {"words": "Switzerland's highest court", "phonetic": "/ˈswɪtsələndz ˈhaɪɪst kɔːt/", "description": "Switzerland's结尾的/z/与highest开头的/h/发生辅元连读；highest结尾的/t/与court开头的/k/相邻，发生不完全爆破（失爆）。"},
        {"words": "agreed and overturned", "phonetic": "/əˈɡriːd ən ˌəʊvəˈtɜːnd/", "description": "agreed结尾的/d/与and开头的/æ/发生辅元连读；and弱读为/ən/，结尾的/n/与overturned开头的/əʊ/发生辅元连读。"},
        {"words": "a ruling last year", "phonetic": "/ə ˈruːlɪŋ lɑːst jɪər/", "description": "a弱读为/ə/，与ruling开头的/r/发生辅元连读；ruling结尾的/ŋ/与last开头的/l/发生辅元连读；last结尾的/t/与year开头的/j/相邻，发生不完全爆破。"},
        ...
        {"words": "the supermarket", "phonetic": "/ðə ˈsuːpəmɑːkɪt/", "description": "the弱读为/ðə/，与supermarket开头的/s/发生辅元连读。"},
    ],
    "sense_groups": {
...
DATA["The court suggested the chocolate needn't be wasted; it could be melted for use in other products."] = {
    "connected_speech": [
        {"words": "The court suggested", "phonetic": "/ðə kɔːt səˈdʒestɪd/", "description": "the弱读为/ðə/，与court开头的/k/发生辅元连读；court结尾的/t/与suggested开头的/s/相邻，发生不完全爆破。"},
        {"words": "the chocolate needn't be wasted", "phonetic": "/ðə ˈtʃɒklət ˈniːdnt bi ˈweɪstɪd/", "description": "the弱读为/ðə/，与chocolate开头的/tʃ/发生辅元连读；chocolate结尾的/t/与needn't开头的/n/相邻，发生不完全爆破；needn't结尾的/t/与be开头的/b/相邻，发生不完全爆破。"},
        ...
        {"words": "for use in other products", "phonetic": "/fər juːz ɪn ˈʌðər ˈprɒdʌkts/", "description": "for弱读为/fər/，结尾的/r/与use开头的/j/发生r连读；use结尾的/z/与in开头的/ɪ/发生辅元连读；in结尾的/n/与other开头的/ʌ/发生辅元连读；other结尾的/r/与products开头的/p/发生辅元连读（r连读）。"},
    ],
    "sense_groups": {
...
DATA["The Swiss manufacturer's rabbit has a red bow and bell, while the German supermarket's has a green bow and bell."] = {
    "connected_speech": [
        ...
        {"words": "has a red bow and bell", "phonetic": "/həz ə red bəʊ ən bel/", "description": "has弱读为/həz/，结尾的/z/与a的/ə/发生辅元连读；red结尾的/d/与bow开头的/b/相邻，发生不完全爆破；bow结尾的/əʊ/与and的/ən/发生元元连读；and弱读为/ən/。"},
        {"words": "while the German supermarket's", "phonetic": "/waɪl ðə ˈdʒɜːmən ˈsuːpəmɑːkɪts/", "description": "while结尾的/l/与the的/ðə/发生辅音连读；German结尾的/n/与supermarket's开头的/s/发生辅元连读。"},
        {"words": "has a green bow and bell", "phonetic": "/həz ə ɡriːn bəʊ ən bel/", "description": "has弱读为/həz/，结尾的/z/与a的/ə/发生辅元连读；green结尾的/n/与bow开头的/b/发生辅元连读；bow结尾的/əʊ/与and的/ən/发生元元连读。"},
    ],
    "sense_groups": {
...
DATA["Can you please hand me that book over there? It has instructions for making a winter bean salad."] = {
    "connected_speech": [
        {"words": "Can you please", "phonetic": "/kən ju pliːz/", "description": "can弱读为/kən/；can结尾的/n/与you开头的/j/发生辅元连读；you结尾的/u/与please开头的/p/发生辅元连读。"},
        ...
        {"words": "over there", "phonetic": "/ˈəʊvər ðeər/", "description": "over结尾的/r/与there开头的/ð/发生辅音连读（r连读）。"},
        ...
        {"words": "winter bean salad", "phonetic": "/ˈwɪntər biːn ˈsæləd/", "description": "winter结尾的/r/与bean开头的/b/发生辅元连读(r连读)；bean结尾的/n/与salad开头的/s/发生辅元连读。"},
    ],
    "sense_groups": {
...
DATA["My sister's boyfriend is coming over for dinner. He's vegetarian, so I need to make a lot of vegetable dishes."] = {
    "connected_speech": [
        ...
        {"words": "is coming over for dinner", "phonetic": "/ɪz ˈkʌmɪŋ ˈəʊvər fər ˈdɪnər/", "description": "is结尾的/z/与coming开头的/k/发生辅音连读；coming结尾的/ŋ/与over开头的/əʊ/发生辅元连读；over结尾的/r/与for开头的/f/发生辅元连读(r连读)；for弱读为/fər/。"},
        {"words": "He's vegetarian", "phonetic": "/hiz ˌvedʒɪˈteəriən/", "description": "He's结尾的/z/与vegetarian开头的/v/发生辅音连读。"},
        {"words": "so I need to make", "phonetic": "/səʊ aɪ niːd tə meɪk/", "description": "so结尾的/əʊ/与I开头的/aɪ/发生元元连读；need结尾的/d/与to开头的/t/相邻，发生不完全爆破；to弱读为/tə/。"},
        {"words": "a lot of vegetable dishes", "phonetic": "/ə lɒt əv ˈvedʒtəbəl ˈdɪʃɪz/", "description": "lot结尾的/t/与of开头的/ə/发生辅元连读；of弱读为/əv/，结尾的/v/与vegetable开头的/v/可合并或轻微延长；vegetable结尾的/l/与dishes开头的/d/发生辅元连读。"},
    ],
    "sense_groups": {
...
DATA["He only eats vegetables, no meat. That doesn't sound like a very balanced diet."] = {
    "connected_speech": [
        {"words": "He only eats vegetables", "phonetic": "/hi ˈəʊnli iːts ˈvedʒtəbəlz/", "description": "only结尾的/i/与eats开头的/iː/发生元元连读；eats结尾的/s/与vegetables开头的/v/发生辅音连读。"},
        {"words": "no meat", "phonetic": "/nəʊ miːt/", "description": "no结尾的/əʊ/与meat开头的/m/发生辅元连读。"},
        ...
        {"words": "a very balanced diet", "phonetic": "/ə ˈveri ˈbælənst ˈdaɪət/", "description": "a弱读为/ə/，与very开头的/v/发生辅元连读；balanced结尾的/t/与diet开头的/d/相邻，发生不完全爆破。"},
    ],
    "sense_groups": {
...
DATA["How can he get enough protein? What does he do to strengthen his muscles and all that?"] = {
    "connected_speech": [
        ...
        {"words": "enough protein", "phonetic": "/ɪˈnʌf ˈprəʊtiːn/", "description": "enough结尾的/f/与protein开头的/p/发生辅音连读。"},
        {"words": "What does he do", "phonetic": "/wɒt dəz hi du/", "description": "what结尾的/t/与does开头的/d/相邻，发生不完全爆破；does弱读为/dəz/，结尾的/z/与he开头的/h/发生辅元连读；he结尾的/i/与do开头的/d/发生辅元连读。"},
        ...
        {"words": "and all that", "phonetic": "/ən ɔːl ðət/", "description": "and弱读为/ən/，结尾的/n/与all开头的/ɔː/发生辅元连读；all结尾的/l/与that的/ðət/发生辅音连读；that弱读为/ðət/。"},
    ],
    "sense_groups": {
...
DATA["Apparently that's no problem. He eats a variety of different vegetables and nuts, especially those with high amounts of protein."] = {
    "connected_speech": [
        {"words": "Apparently that's no problem", "phonetic": "/əˈpærəntli ðəts nəʊ ˈprɒbləm/", "description": "Apparently结尾的/i/与that's开头的/ð/发生辅元连读；that's结尾的/s/与no开头的/n/发生辅音连读。"},
        {"words": "He eats a variety of", "phonetic": "/hi iːts ə vəˈraɪəti əv/", "description": "eats结尾的/s/与a的/ə/发生辅元连读；a的/ə/与variety开头的/v/发生辅元连读；variety结尾的/i/与of开头的/ə/发生元元连读；of弱读为/əv/。"},
        ...
        {"words": "especially those with", "phonetic": "/ɪˈspeʃəli ðəʊz wɪð/", "description": "especially结尾的/i/与those开头的/ð/发生辅元连读；those结尾的/z/与with开头的/w/发生辅音连读。"},
        {"words": "high amounts of protein", "phonetic": "/haɪ əˈmaʊnts əv ˈprəʊtiːn/", "description": "high结尾的/aɪ/与amounts开头的/ə/发生元元连读；amounts结尾的/s/与of开头的/ə/发生辅元连读；of弱读为/əv/，结尾的/v/与protein开头的/p/发生辅音连读。"},
    ],
    "sense_groups": {
...
DATA["He's an animal activist. He's always been very sensitive and sympathizes with animals."] = {
    "connected_speech": [
        ...
        {"words": "He's always been", "phonetic": "/hiz ˈɔːlweɪz biːn/", "description": "He's结尾的/z/与always开头的/ɔː/发生辅元连读；always结尾的/z/与been开头的/b/发生辅音连读。"},
...
DATA["He says that keeping animals in zoos and parks causes them great distress."] = {
    "connected_speech": [
        {"words": "He says that keeping", "phonetic": "/hi sez ðət ˈkiːpɪŋ/", "description": "says结尾的/z/与that开头的/ð/发生辅音连读；that弱读为/ðət/，结尾的/t/与keeping开头的/k/相邻，发生不完全爆破。"},
        {"words": "animals in zoos and parks", "phonetic": "/ˈænɪməlz ɪn zuːz ən pɑːks/", "description": "animals结尾的/z/与in开头的/ɪ/发生辅元连读；in结尾的/n/与zoos开头的/z/发生辅元连读；zoos结尾的/z/与and的/ən/发生辅元连读；and弱读为/ən/，结尾的/n/与parks开头的/p/发生辅元连读。"},
        {"words": "causes them great distress", "phonetic": "/ˈkɔːzɪz ðəm ɡreɪt dɪˈstres/", "description": "causes结尾的/z/与them开头的/ð/发生辅音连读；them弱读为/ðəm/；great结尾的/t/与distress开头的/d/相邻，发生不完全爆破（失爆）。"},
    ],
    "sense_groups": {
...
DATA["Not all zoos and animal parks have the most favorable conditions, but without them it just wouldn't be feasible to learn about animals."] = {
    "connected_speech": [
        {"words": "Not all zoos and animal parks", "phonetic": "/nɒt ɔːl zuːz ən ˈænɪməl pɑːks/", "description": "not结尾的/t/与all开头的/ɔː/发生辅元连读；all结尾的/l/与zoos开头的/z/发生辅元连读；zoos结尾的/z/与and的/ən/发生辅元连读；and弱读为/ən/。"},
        {"words": "have the most favorable conditions", "phonetic": "/həv ðə məʊst ˈfeɪvərəbəl kənˈdɪʃənz/", "description": "have弱读为/həv/，结尾的/v/与the的/ðə/发生辅元连读；most结尾的/t/与favorable开头的/f/相邻，发生不完全爆破；favorable结尾的/l/与conditions开头的/k/发生辅元连读。"},
        ...
        {"words": "it just wouldn't be feasible", "phonetic": "/ɪt dʒʌst ˈwʊdnt bi ˈfiːzəbəl/", "description": "it结尾的/t/与just开头的/dʒ/相邻，发生不完全爆破；just结尾的/t/与wouldn't开头的/w/相邻，发生不完全爆破；wouldn't结尾的/t/与be开头的/b/相邻，发生不完全爆破。"},
        {"words": "to learn about animals", "phonetic": "/tə lɜːn əˈbaʊt ˈænɪməlz/", "description": "to弱读为/tə/，与learn开头的/l/发生辅元连读；learn结尾的/n/与about开头的/ə/发生辅元连读；about结尾的/t/与animals开头的/æ/相邻，发生不完全爆破。"},
    ],
    "sense_groups": {
...
DATA["I don't think I could ever give up a good hot dog at a baseball game."] = {
    "connected_speech": [
        {"words": "I don't think I could", "phonetic": "/aɪ dəʊnt θɪŋk aɪ kʊd/", "description": "don't结尾的/t/与think开头的/θ/相邻，发生不完全爆破（失爆）；think结尾的/k/与I开头的/aɪ/发生辅元连读；I结尾的/aɪ/与could开头的/k/发生元辅连读。"},
        ...
        {"words": "good hot dog", "phonetic": "/ɡʊd hɒt dɒɡ/", "description": "good结尾的/d/与hot开头的/h/相邻，发生不完全爆破；hot结尾的/t/与dog开头的/d/相邻，发生不完全爆破（失爆）。"},
        {"words": "at a baseball game", "phonetic": "/ət ə ˈbeɪsbɔːl ɡeɪm/", "description": "at弱读为/ət/，结尾的/t/与a的/ə/发生辅元连读；a的/ə/与baseball开头的/b/发生辅元连读；baseball结尾的/l/与game开头的/ɡ/发生辅音连读。"},
    ],
    "sense_groups": {
...
DATA["Did you see that television program on air travel last night?"] = {
    "connected_speech": [
        {"words": "Did you see that", "phonetic": "/dɪd ju siː ðət/", "description": "did结尾的/d/与you开头的/j/发生辅元连读；you结尾的/u/与see开头的/s/发生辅元连读；that弱读为/ðət/。"},
        {"words": "television program", "phonetic": "/ˈtelɪvɪʒən ˈprəʊɡræm/", "description": "television结尾的/n/与program开头的/p/发生辅元连读。"},
        {"words": "on air travel", "phonetic": "/ɒn eər ˈtrævəl/", "description": "on结尾的/n/与air开头的/eə/发生辅元连读；air结尾的/r/与travel开头的/t/发生辅元连读（r连读）。"},
        {"words": "last night", "phonetic": "/lɑːst naɪt/", "description": "last结尾的/t/与night开头的/n/相邻，发生不完全爆破（失爆）。"},
    ],
    "sense_groups": {
...
DATA["I was surprised that the expert recommended not eating for the entire journey and avoiding sleeping on the plane."] = {
    "connected_speech": [
        ...
        {"words": "the expert recommended", "phonetic": "/ði ˈekspɜːt ˌrekəˈmendɪd/", "description": "the在元音前读/ði/，与expert开头的/e/发生元元连读；expert结尾的/t/与recommended开头的/r/发生辅元连读。"},
        {"words": "not eating for the entire journey", "phonetic": "/nɒt ˈiːtɪŋ fər ði ɪnˈtaɪər ˈdʒɜːni/", "description": "not结尾的/t/与eating开头的/iː/发生辅元连读；eating结尾的/ŋ/与for开头的/f/发生辅元连读；for弱读为/fər/；the在元音前读/ði/。"},
        {"words": "and avoiding sleeping", "phonetic": "/ən əˈvɔɪdɪŋ ˈsliːpɪŋ/", "description": "and弱读为/ən/，结尾的/n/与avoiding开头的/ə/发生辅元连读；avoiding结尾的/ŋ/与sleeping开头的/s/发生辅元连读。"},
        {"words": "on the plane", "phonetic": "/ɒn ðə pleɪn/", "description": "on结尾的/n/与the的/ðə/发生辅元连读；the弱读为/ðə/，与plane开头的/p/发生辅元连读。"},
    ],
    "sense_groups": {
...
DATA["I read an article on the subject in the past that suggested the opposite — that it was important not to miss meals."] = {
    "connected_speech": [
        {"words": "I read an article", "phonetic": "/aɪ red ən ˈɑːtɪkəl/", "description": "read结尾的/d/与an的/ən/发生辅元连读；an结尾的/n/与article开头的/ɑː/发生辅元连读。"},
        {"words": "on the subject in the past", "phonetic": "/ɒn ðə ˈsʌbdʒɪkt ɪn ðə pɑːst/", "description": "on结尾的/n/与the的/ðə/发生辅元连读；subject结尾的/t/与in开头的/ɪ/发生辅元连读；in结尾的/n/与the的/ðə/发生辅元连读。"},
        {"words": "that suggested the opposite", "phonetic": "/ðət səˈdʒestɪd ði ˈɒpəzɪt/", "description": "that弱读为/ðət/；suggested结尾的/d/与the的/ði/相邻，发生不完全爆破；the在元音前读/ði/，与opposite的/ɒ/发生元元连读。"},
        {"words": "that it was important", "phonetic": "/ðət ɪt wəz ɪmˈpɔːtənt/", "description": "that弱读为/ðət/，结尾的/t/与it开头的/ɪ/发生辅元连读；it结尾的/t/与was开头的/w/相邻，发生不完全爆破；was弱读为/wəz/。"},
        {"words": "not to miss meals", "phonetic": "/nɒt tə mɪs miːlz/", "description": "not结尾的/t/与to开头的/t/相邻，发生不完全爆破；to弱读为/tə/；miss结尾的/s/与meals开头的/m/发生辅音连读。"},
    ],
    "sense_groups": {
...
DATA["Well, the expert on the show did cite research supporting her recommendations, so I guess I'll give it a try next time."] = {
    "connected_speech": [
        {"words": "the expert on the show", "phonetic": "/ði ˈekspɜːt ɒn ðə ʃəʊ/", "description": "the在元音前读/ði/，与expert的/e/发生元元连读；expert结尾的/t/与on开头的/ɒ/发生辅元连读；on结尾的/n/与the的/ðə/发生辅元连读。"},
        {"words": "did cite research", "phonetic": "/dɪd saɪt rɪˈsɜːtʃ/", "description": "did结尾的/d/与cite开头的/s/相邻，发生不完全爆破（失爆）；cite结尾的/t/与research开头的/r/发生辅元连读。"},
        {"words": "supporting her recommendations", "phonetic": "/səˈpɔːtɪŋ hər ˌrekəmenˈdeɪʃənz/", "description": "supporting结尾的/ŋ/与her开头的/h/发生辅元连读；her弱读为/hər/，结尾的/r/与recommendations开头的/r/可合并或轻微延长。"},
        {"words": "so I guess I'll", "phonetic": "/səʊ aɪ ɡes aɪl/", "description": "so结尾的/əʊ/与I开头的/aɪ/发生元元连读；guess结尾的/s/与I'll开头的/aɪ/发生辅元连读。"},
...
DATA["Jet lag is a big problem for me and has been for the last few years even though I never suffered from it before."] = {
    "connected_speech": [
        {"words": "Jet lag is a big problem", "phonetic": "/dʒet læɡ ɪz ə bɪɡ ˈprɒbləm/", "description": "jet结尾的/t/与lag开头的/l/相邻，发生不完全爆破（失爆）；lag结尾的/ɡ/与is开头的/ɪ/发生辅元连读；is结尾的/z/与a的/ə/发生辅元连读；big结尾的/ɡ/与problem开头的/p/相邻，发生不完全爆破。"},
        {"words": "for me and has been", "phonetic": "/fər mi ən həz biːn/", "description": "for弱读为/fər/；me结尾的/i/与and的/ən/发生辅元连读；and弱读为/ən/；has弱读为/həz/。"},
        {"words": "for the last few years", "phonetic": "/fər ðə lɑːst fjuː jɪərz/", "description": "for弱读为/fər/；last结尾的/t/与few开头的/f/相邻，发生不完全爆破；few结尾的/u/与years开头的/j/发生元元连读。"},
        {"words": "even though I never", "phonetic": "/ˈiːvən ðəʊ aɪ ˈnevər/", "description": "even结尾的/n/与though开头的/ð/发生辅元连读；though结尾的/əʊ/与I开头的/aɪ/发生元元连读；never结尾的/r/在美式中可与后续元音发生r连读。"},
        {"words": "suffered from it before", "phonetic": "/ˈsʌfəd frəm ɪt bɪˈfɔːr/", "description": "suffered结尾的/d/与from开头的/f/相邻，发生不完全爆破；from弱读为/frəm/，结尾的/m/与it开头的/ɪ/发生辅元连读；it结尾的/t/与before开头的/b/相邻，发生不完全爆破。"},
    ],
    "sense_groups": {
...
DATA["She did say that jet lag often becomes more of a problem after 40, so I guess I'm lucky that I can still adjust."] = {
    "connected_speech": [
        ...
        {"words": "jet lag often becomes", "phonetic": "/dʒet læɡ ˈɒfən bɪˈkʌmz/", "description": "jet结尾的/t/与lag开头的/l/相邻，发生不完全爆破；lag结尾的/ɡ/与often开头的/ɒ/发生辅元连读；often结尾的/n/与becomes开头的/b/发生辅元连读。"},
        {"words": "more of a problem after 40", "phonetic": "/mɔːr əv ə ˈprɒbləm ˈɑːftər ˈfɔːti/", "description": "more结尾的/r/与of开头的/ə/发生r连读；of弱读为/əv/，结尾的/v/与a的/ə/发生辅元连读；problem结尾的/m/与after开头的/ɑː/发生辅元连读；after结尾的/r/与40的/ˈfɔːti/首音/f/发生r连读。"},
        {"words": "so I guess I'm lucky", "phonetic": "/səʊ aɪ ɡes aɪm ˈlʌki/", "description": "so结尾的/əʊ/与I开头的/aɪ/发生元元连读；guess结尾的/s/与I'm开头的/aɪ/发生辅元连读。"},
...
DATA["Actually, my mother is terrified of airplanes to the point where she can't even fly, so our family vacations were always by car or train."] = {
    "connected_speech": [
        ...
        {"words": "of airplanes", "phonetic": "/əv ˈeərpleɪnz/", "description": "of弱读为/əv/，结尾的/v/与airplanes开头的/eə/发生辅元连读。"},
        {"words": "to the point where", "phonetic": "/tə ðə pɔɪnt weər/", "description": "to弱读为/tə/，与the的/ðə/发生辅元连读；point结尾的/t/与where开头的/w/相邻，发生不完全爆破（失爆）。"},
        {"words": "she can't even fly", "phonetic": "/ʃi kɑːnt ˈiːvən flaɪ/", "description": "can't结尾的/t/与even开头的/iː/发生辅元连读；even结尾的/n/与fly开头的/f/发生辅元连读。"},
        {"words": "so our family vacations", "phonetic": "/səʊ aʊər ˈfæmɪli veɪˈkeɪʃənz/", "description": "so结尾的/əʊ/与our的/aʊə/发生元元连读；our结尾的/r/与family开头的/f/发生r连读（辅元连读）。"},
        {"words": "were always by car or train", "phonetic": "/wər ˈɔːlweɪz baɪ kɑːr ɔːr treɪn/", "description": "were弱读为/wər/，结尾的/r/与always开头的/ɔː/发生r连读；always结尾的/z/与by开头的/b/发生辅音连读；by结尾的/aɪ/与car开头的/k/发生辅元连读；car结尾的/r/与or开头的/ɔː/发生r连读；or结尾的/r/与train开头的/t/发生r连读。"},
    ],
    "sense_groups": {
...
DATA["I just get anxious before I fly and feel nervous the whole time we're in the air."] = {
    "connected_speech": [
        ...
        {"words": "before I fly", "phonetic": "/bɪˈfɔːr aɪ flaɪ/", "description": "before结尾的/r/与I开头的/aɪ/发生r连读（辅元连读）；I结尾的/aɪ/与fly开头的/f/发生元辅连读。"},
        {"words": "and feel nervous", "phonetic": "/ən fiːl ˈnɜːvəs/", "description": "and弱读为/ən/，结尾的/n/与feel开头的/f/发生辅元连读；feel结尾的/l/与nervous开头的/n/发生辅音连读。"},
        {"words": "the whole time", "phonetic": "/ðə həʊl taɪm/", "description": "the弱读为/ðə/，与whole开头的/h/发生辅元连读（h可弱读省略）；whole结尾的/l/与time开头的/t/发生辅音连读。"},
        {"words": "we're in the air", "phonetic": "/wɪər ɪn ði eər/", "description": "we're结尾的/r/与in开头的/ɪ/发生r连读；in结尾的/n/与the的/ði/发生辅元连读；the在元音前读/ði/，与air的/eə/发生元元连读。"},
    ],
    "sense_groups": {
...
DATA["The expert said 20% of people are afraid to fly, but actually it was a quarter of people, so the problem really is widespread."] = {
    "connected_speech": [
        {"words": "The expert said 20%", "phonetic": "/ði ˈekspɜːt sed ˈtwenti pəˈsent/", "description": "the在元音前读/ði/；expert结尾的/t/与said开头的/s/相邻，发生不完全爆破（失爆）；said结尾的/d/与20%开头的/t/相邻，发生不完全爆破。"},
        {"words": "of people are afraid to fly", "phonetic": "/əv ˈpiːpəl ər əˈfreɪd tə flaɪ/", "description": "of弱读为/əv/，结尾的/v/与people开头的/p/发生辅音连读；people结尾的/l/与are开头的/ɑː/发生辅元连读；are弱读为/ər/；afraid结尾的/d/与to开头的/t/相邻，发生不完全爆破；to弱读为/tə/。"},
        ...
        {"words": "a quarter of people", "phonetic": "/ə ˈkwɔːtər əv ˈpiːpəl/", "description": "quarter结尾的/r/与of开头的/ə/发生r连读；of弱读为/əv/。"},
        {"words": "so the problem really is widespread", "phonetic": "/səʊ ðə ˈprɒbləm ˈrɪəli ɪz ˈwaɪdspred/", "description": "so结尾的/əʊ/与the的/ðə/发生元辅连读；problem结尾的/m/与really开头的/r/发生辅元连读；really结尾的/i/与is开头的/ɪ/发生元元连读；is结尾的/z/与widespread开头的/w/发生辅音连读。"},
    ],
    "sense_groups": {
...
DATA["Nothing can substitute real world experience when it comes to getting started in user experience design."] = {
    "connected_speech": [
        {"words": "Nothing can substitute", "phonetic": "/ˈnʌθɪŋ kæn ˈsʌbstɪtjuːt/", "description": "Nothing结尾的/ŋ/与can开头的/k/发生辅元连读；can弱读为/kæn/，结尾的/n/与substitute开头的/s/发生辅元连读。"},
        {"words": "real world experience", "phonetic": "/rɪəl wɜːld ɪkˈspɪəriəns/", "description": "real结尾的/l/与world开头的/w/发生辅音连读；world结尾的/d/与experience开头的/ɪ/相邻，发生不完全爆破（失爆）。"},
        ...
        {"words": "getting started in", "phonetic": "/ˈɡetɪŋ ˈstɑːtɪd ɪn/", "description": "getting结尾的/ŋ/与started开头的/s/发生辅元连读；started结尾的/d/与in开头的/ɪ/发生辅元连读。"},
        {"words": "user experience design", "phonetic": "/ˈjuːzə ɪkˈspɪəriəns dɪˈzaɪn/", "description": "user结尾的/r/与experience开头的/ɪ/发生r连读（辅元连读）；experience结尾的/s/与design开头的/d/发生辅音连读。"},
    ],
    "sense_groups": {
...
DATA["Higher education is a great way to equip yourself with some core skills, but it will not prepare you for actual challenges with clients."] = {
    "connected_speech": [
        {"words": "Higher education is a great way", "phonetic": "/ˈhaɪər ˌedjuˈkeɪʃən ɪz ə ɡreɪt weɪ/", "description": "Higher结尾的/r/与education开头的/e/发生r连读；education结尾的/n/与is开头的/ɪ/发生辅元连读；is结尾的/z/与a的/ə/发生辅元连读；great结尾的/t/与way开头的/w/相邻，发生不完全爆破。"},
        ...
        {"words": "some core skills", "phonetic": "/səm kɔːr skɪlz/", "description": "some弱读为/səm/；core结尾的/r/与skills开头的/s/发生r连读（辅元连读）。"},
        {"words": "but it will not prepare you", "phonetic": "/bət ɪt wɪl nɒt prɪˈpeər ju/", "description": "but结尾的/t/与it开头的/ɪ/发生辅元连读；it结尾的/t/与will开头的/w/相邻，发生不完全爆破；not结尾的/t/与prepare开头的/p/相邻，发生不完全爆破；prepare结尾的/r/与you开头的/j/发生r连读。"},
        ...
        {"words": "with clients", "phonetic": "/wɪð ˈklaɪənts/", "description": "with结尾的/ð/与clients开头的/k/发生辅音连读。"},
    ],
    "sense_groups": {
...
DATA["Being proficient with a design tool and a few methods doesn't make you a user experience designer."] = {
    "connected_speech": [
        {"words": "Being proficient with", "phonetic": "/ˈbiːɪŋ prəˈfɪʃənt wɪð/", "description": "Being结尾的/ŋ/与proficient开头的/p/发生辅元连读；proficient结尾的/t/与with开头的/w/相邻，发生不完全爆破（失爆）。"},
        {"words": "a design tool", "phonetic": "/ə dɪˈzaɪn tuːl/", "description": "a弱读为/ə/，与design开头的/d/发生辅元连读；design结尾的/n/与tool开头的/t/发生辅元连读。"},
        {"words": "and a few methods", "phonetic": "/ən ə fjuː ˈmeθədz/", "description": "and弱读为/ən/，结尾的/n/与a的/ə/发生辅元连读；few结尾的/u/与methods开头的/m/发生辅元连读。"},
        {"words": "doesn't make you", "phonetic": "/ˈdʌznt meɪk ju/", "description": "doesn't结尾的/t/与make开头的/m/相邻，发生不完全爆破；make结尾的/k/与you开头的/j/发生辅元连读。"},
        {"words": "a user experience designer", "phonetic": "/ə ˈjuːzə ɪkˈspɪəriəns dɪˈzaɪnər/", "description": "user结尾的/r/与experience开头的/ɪ/发生r连读；experience结尾的/s/与designer开头的/d/发生辅音连读。"},
    ],
    "sense_groups": {
...
DATA["There simply isn't a one size fits all process. Being effective requires adaptability, something you don't really learn in school."] = {
    "connected_speech": [
        {"words": "There simply isn't", "phonetic": "/ðeər ˈsɪmpli ˈɪznt/", "description": "There结尾的/r/与simply开头的/s/发生r连读；simply结尾的/i/与isn't开头的/ɪ/发生元元连读。"},
        {"words": "a one size fits all process", "phonetic": "/ə wʌn saɪz fɪts ɔːl ˈprəʊses/", "description": "one结尾的/n/与size开头的/s/发生辅元连读；size结尾的/z/与fits开头的/f/发生辅音连读；fits结尾的/s/与all开头的/ɔː/发生辅元连读。"},
        {"words": "Being effective requires adaptability", "phonetic": "/ˈbiːɪŋ ɪˈfektɪv rɪˈkwaɪərz əˌdæptəˈbɪlɪti/", "description": "Being结尾的/ŋ/与effective开头的/ɪ/发生辅元连读；effective结尾的/v/与requires开头的/r/发生辅音连读；requires结尾的/z/与adaptability开头的/ə/发生辅元连读。"},
        {"words": "something you don't really learn", "phonetic": "/ˈsʌmθɪŋ ju dəʊnt ˈrɪəli lɜːn/", "description": "something结尾的/ŋ/与you开头的/j/发生辅元连读；don't结尾的/t/与really开头的/r/相邻，发生不完全爆破；really结尾的/i/与learn开头的/l/发生辅元连读。"},
        {"words": "in school", "phonetic": "/ɪn skuːl/", "description": "in结尾的/n/与school开头的/s/发生辅元连读。"},
    ],
    "sense_groups": {
...
DATA["I found my way to user experience through graphic design and slowly over many different roles and experiences."] = {
    "connected_speech": [
        ...
        {"words": "user experience", "phonetic": "/ˈjuːzər ɪkˈspɪəriəns/", "description": "user结尾的/r/与experience开头的/ɪ/发生r连读（辅元连读）。"},
        {"words": "through graphic design", "phonetic": "/θruː ˈɡræfɪk dɪˈzaɪn/", "description": "through结尾的/u/与graphic开头的/ɡ/发生辅元连读；graphic结尾的/k/与design开头的/d/相邻，发生不完全爆破。"},
        {"words": "and slowly over many", "phonetic": "/ən ˈsləʊli ˈəʊvər ˈmeni/", "description": "and弱读为/ən/，结尾的/n/与slowly开头的/s/发生辅元连读；slowly结尾的/i/与over开头的/əʊ/发生元元连读；over结尾的/r/与many开头的/m/发生辅元连读(r连读)。"},
        {"words": "different roles and experiences", "phonetic": "/ˈdɪfrənt rəʊlz ən ɪkˈspɪəriənsɪz/", "description": "different结尾的/t/与roles开头的/r/发生辅元连读；roles结尾的/z/与and的/ən/发生辅元连读；and弱读为/ən/。"},
    ],
    "sense_groups": {
...
DATA["It took time and commitment to continue to pursue roles within teams that I knew could teach and challenge me."] = {
    "connected_speech": [
        ...
        {"words": "to continue to pursue roles", "phonetic": "/tə kənˈtɪnjuː tə pəˈsjuː rəʊlz/", "description": "to弱读为/tə/，与continue开头的/k/发生辅元连读；continue结尾的/u/与to的/tə/发生辅元连读；pursue结尾的/u/与roles开头的/r/发生辅元连读。"},
        {"words": "within teams", "phonetic": "/wɪˈðɪn tiːmz/", "description": "within结尾的/n/与teams开头的/t/发生辅元连读。"},
        {"words": "that I knew could teach", "phonetic": "/ðət aɪ njuː kʊd tiːtʃ/", "description": "that弱读为/ðət/，结尾的/t/与I开头的/aɪ/发生辅元连读；knew结尾的/u/与could开头的/k/发生辅元连读；could结尾的/d/与teach开头的/t/相邻，发生不完全爆破。"},
...
DATA["You can start anywhere as long as you know your end goal and you commit to actively pursue opportunities to learn and grow."] = {
    "connected_speech": [
        {"words": "You can start anywhere", "phonetic": "/ju kæn stɑːt ˈeniweər/", "description": "can弱读为/kæn/，结尾的/n/与start开头的/s/发生辅元连读；start结尾的/t/与anywhere开头的/e/发生辅元连读。"},
        {"words": "as long as you know", "phonetic": "/əz lɒŋ əz ju nəʊ/", "description": "as弱读为/əz/，结尾的/z/与long开头的/l/发生辅元连读；long结尾的/ŋ/与as的/əz/发生辅元连读；as结尾的/z/与you开头的/j/发生辅音连读。"},
        {"words": "your end goal", "phonetic": "/jər end ɡəʊl/", "description": "your弱读为/jər/；end结尾的/d/与goal开头的/ɡ/相邻，发生不完全爆破（失爆）。"},
        ...
        {"words": "pursue opportunities", "phonetic": "/pəˈsjuː ˌɒpəˈtjuːnɪtiz/", "description": "pursue结尾的/u/与opportunities开头的/ɒ/发生元元连读。"},
        {"words": "to learn and grow", "phonetic": "/tə lɜːn ən ɡrəʊ/", "description": "to弱读为/tə/，与learn开头的/l/发生辅元连读；learn结尾的/n/与and的/ən/发生辅元连读；and弱读为/ən/。"},
    ],
    "sense_groups": {
...
DATA["When planning for this year, our principal asked what needed to change to engage students more in their learning."] = {
    "connected_speech": [
        {"words": "When planning for this year", "phonetic": "/wen ˈplænɪŋ fər ðɪs jɪər/", "description": "when结尾的/n/与planning开头的/p/发生辅元连读；planning结尾的/ŋ/与for开头的/f/发生辅元连读；for弱读为/fər/；this结尾的/s/与year开头的/j/发生辅元连读。"},
        {"words": "our principal asked", "phonetic": "/aʊər ˈprɪnsɪpəl ɑːskt/", "description": "our结尾的/r/与principal开头的/p/发生r连读（辅元连读）；principal结尾的/l/与asked开头的/ɑː/发生辅元连读。"},
        {"words": "what needed to change", "phonetic": "/wɒt ˈniːdɪd tə tʃeɪndʒ/", "description": "what结尾的/t/与needed开头的/n/相邻，发生不完全爆破（失爆）；needed结尾的/d/与to开头的/t/相邻，发生不完全爆破；to弱读为/tə/，与change开头的/tʃ/发生辅元连读。"},
        {"words": "to engage students more", "phonetic": "/tu ɪnˈɡeɪdʒ ˈstjuːdənts mɔːr/", "description": "to弱读为/tu/；engage结尾的/dʒ/与students开头的/s/发生辅音连读；students结尾的/s/与more开头的/m/发生辅音连读。"},
        {"words": "in their learning", "phonetic": "/ɪn ðeər ˈlɜːnɪŋ/", "description": "in结尾的/n/与their开头的/ð/发生辅元连读；their结尾的/r/与learning开头的/l/发生r连读。"},
    ],
    "sense_groups": {
...
DATA["I responded in a whisper: flexible seating, thinking about our classroom with rows of desks and name plates."] = {
    "connected_speech": [
        {"words": "I responded in a whisper", "phonetic": "/aɪ rɪˈspɒndɪd ɪn ə ˈwɪspər/", "description": "responded结尾的/d/与in开头的/ɪ/发生辅元连读；in结尾的/n/与a的/ə/发生辅元连读。"},
        {"words": "flexible seating", "phonetic": "/ˈfleksɪbəl ˈsiːtɪŋ/", "description": "flexible结尾的/l/与seating开头的/s/发生辅音连读。"},
        {"words": "thinking about our classroom", "phonetic": "/ˈθɪŋkɪŋ əˈbaʊt aʊər ˈklɑːsruːm/", "description": "thinking结尾的/ŋ/与about开头的/ə/发生辅元连读；about结尾的/t/与our开头的/aʊ/发生辅元连读；our结尾的/r/与classroom开头的/k/发生r连读（辅元连读）。"},
        {"words": "with rows of desks", "phonetic": "/wɪð rəʊz əv desks/", "description": "with结尾的/ð/与rows开头的/r/发生辅音连读；rows结尾的/z/与of开头的/ə/发生辅元连读；of弱读为/əv/，结尾的/v/与desks开头的/d/发生辅音连读。"},
...
DATA["Flexible seating has been defined as movable furniture to create an engaging learning environment."] = {
    "connected_speech": [
        {"words": "Flexible seating has been", "phonetic": "/ˈfleksɪbəl ˈsiːtɪŋ həz biːn/", "description": "flexible结尾的/l/与seating开头的/s/发生辅音连读；seating结尾的/ŋ/与has开头的/h/发生辅元连读；has弱读为/həz/，结尾的/z/与been开头的/b/发生辅音连读。"},
        {"words": "defined as movable furniture", "phonetic": "/dɪˈfaɪnd əz ˈmuːvəbəl ˈfɜːnɪtʃər/", "description": "defined结尾的/d/与as开头的/ə/发生辅元连读；as弱读为/əz/，结尾的/z/与movable开头的/m/发生辅音连读；movable结尾的/l/与furniture开头的/f/发生辅音连读。"},
        ...
        {"words": "learning environment", "phonetic": "/ˈlɜːnɪŋ ɪnˈvaɪrənmənt/", "description": "learning结尾的/ŋ/与environment开头的/ɪ/发生辅元连读。"},
    ],
    "sense_groups": {
...
DATA["It is a shift in practice from being teacher focused to student focused learning."] = {
    "connected_speech": [
        ...
        {"words": "from being teacher focused", "phonetic": "/frəm ˈbiːɪŋ ˈtiːtʃər ˈfəʊkəst/", "description": "from弱读为/frəm/，结尾的/m/与being开头的/b/发生辅元连读；being结尾的/ŋ/与teacher开头的/t/发生辅元连读；teacher结尾的/r/与focused开头的/f/发生辅元连读(r连读)。"},
        {"words": "to student focused learning", "phonetic": "/tə ˈstjuːdənt ˈfəʊkəst ˈlɜːnɪŋ/", "description": "to弱读为/tə/，与student开头的/s/发生辅元连读；student结尾的/t/与focused开头的/f/相邻，发生不完全爆破；focused结尾的/t/与learning开头的/l/相邻，发生不完全爆破。"},
    ],
    "sense_groups": {
...
DATA["For us, flexible seating has meant removing most of the traditional chairs and desks and introducing a variety of seating options."] = {
    "connected_speech": [
        {"words": "For us, flexible seating", "phonetic": "/fər ʌs ˈfleksɪbəl ˈsiːtɪŋ/", "description": "for弱读为/fər/，结尾的/r/与us开头的/ʌ/发生r连读；flexible结尾的/l/与seating开头的/s/发生辅音连读。"},
        {"words": "has meant removing", "phonetic": "/həz ment rɪˈmuːvɪŋ/", "description": "has弱读为/həz/，结尾的/z/与meant开头的/m/发生辅音连读；meant结尾的/t/与removing开头的/r/发生辅元连读。"},
        {"words": "most of the traditional", "phonetic": "/məʊst əv ðə trəˈdɪʃənəl/", "description": "most结尾的/t/与of开头的/ə/发生辅元连读；of弱读为/əv/；the弱读为/ðə/；traditional结尾的/l/与chairs开头的/tʃ/发生辅音连读。"},
        {"words": "chairs and desks", "phonetic": "/tʃeərz ən desks/", "description": "chairs结尾的/z/与and的/ən/发生辅元连读；and弱读为/ən/，结尾的/n/与desks开头的/d/发生辅元连读。"},
        {"words": "and introducing a variety of", "phonetic": "/ən ˌɪntrəˈdjuːsɪŋ ə vəˈraɪəti əv/", "description": "and弱读为/ən/，结尾的/n/与introducing开头的/ɪ/发生辅元连读；introducing结尾的/ŋ/与a的/ə/发生辅元连读；variety结尾的/i/与of的/ə/发生元元连读；of弱读为/əv/。"},
        {"words": "seating options", "phonetic": "/ˈsiːtɪŋ ˈɒpʃənz/", "description": "seating结尾的/ŋ/与options开头的/ɒ/发生辅元连读。"},
    ],
    "sense_groups": {
...
DATA["Teachers tend to still use the rows format because of either the need to control students or the belief that the teacher is the most important person."] = {
    "connected_speech": [
        {"words": "Teachers tend to still use", "phonetic": "/ˈtiːtʃərz tend tə stɪl juːz/", "description": "Teachers结尾的/z/与tend开头的/t/发生辅音连读；tend结尾的/d/与to开头的/t/相邻，发生不完全爆破；to弱读为/tə/；still结尾的/l/与use开头的/j/发生辅音连读。"},
        {"words": "the rows format", "phonetic": "/ðə rəʊz ˈfɔːmæt/", "description": "the弱读为/ðə/，与rows开头的/r/发生辅元连读；rows结尾的/z/与format开头的/f/发生辅音连读。"},
        {"words": "because of either the need", "phonetic": "/bɪˈkɒz əv ˈaɪðər ðə niːd/", "description": "because结尾的/z/与of开头的/ə/发生辅元连读；of弱读为/əv/，结尾的/v/与either开头的/aɪ/发生辅元连读；either结尾的/r/与the的/ðə/发生r连读。"},
        {"words": "to control students", "phonetic": "/tə kənˈtrəʊl ˈstjuːdənts/", "description": "to弱读为/tə/，与control开头的/k/发生辅元连读；control结尾的/l/与students开头的/s/发生辅音连读。"},
        {"words": "or the belief that the teacher", "phonetic": "/ɔːr ðə bɪˈliːf ðət ðə ˈtiːtʃər/", "description": "or结尾的/r/与the的/ðə/发生r连读；belief结尾的/f/与that的/ðət/发生辅音连读；that弱读为/ðət/。"},
        {"words": "is the most important person", "phonetic": "/ɪz ðə məʊst ɪmˈpɔːtənt ˈpɜːsən/", "description": "is结尾的/z/与the的/ðə/发生辅元连读；the弱读为/ðə/；most结尾的/t/与important开头的/ɪ/发生辅元连读；important结尾的/t/与person开头的/p/相邻，发生不完全爆破。"},
    ],
    "sense_groups": {
...
DATA["Flexible seating enhances student ownership of space and engagement in learning while reducing rates of disengagement."] = {
    "connected_speech": [
        {"words": "Flexible seating enhances", "phonetic": "/ˈfleksɪbəl ˈsiːtɪŋ ɪnˈhɑːnsɪz/", "description": "flexible结尾的/l/与seating开头的/s/发生辅音连读；seating结尾的/ŋ/与enhances开头的/ɪ/发生辅元连读。"},
        {"words": "student ownership of space", "phonetic": "/ˈstjuːdənt ˈəʊnəʃɪp əv speɪs/", "description": "student结尾的/t/与ownership开头的/əʊ/发生辅元连读；ownership结尾的/p/与of开头的/ə/发生辅元连读；of弱读为/əv/，结尾的/v/与space开头的/s/发生辅音连读。"},
        {"words": "and engagement in learning", "phonetic": "/ən ɪnˈɡeɪdʒmənt ɪn ˈlɜːnɪŋ/", "description": "and弱读为/ən/，结尾的/n/与engagement开头的/ɪ/发生辅元连读；engagement结尾的/t/与in开头的/ɪ/发生辅元连读；in结尾的/n/与learning开头的/l/发生辅元连读。"},
        {"words": "while reducing rates of disengagement", "phonetic": "/waɪl rɪˈdjuːsɪŋ reɪts əv ˌdɪsɪnˈɡeɪdʒmənt/", "description": "while结尾的/l/与reducing开头的/r/发生辅音连读；reducing结尾的/ŋ/与rates开头的/r/发生辅元连读；rates结尾的/s/与of开头的/ə/发生辅元连读；of弱读为/əv/。"},
    ],
    "sense_groups": {
...
DATA["Dozens of British students arriving for their first day of school on Tuesday were sent home over their shoes."] = {
    "connected_speech": [
        {"words": "Dozens of British students", "phonetic": "/ˈdʌzənz əv ˈbrɪtɪʃ ˈstjuːdənts/", "description": "Dozens结尾的/z/与of开头的/ə/发生辅元连读；of弱读为/əv/，结尾的/v/与British开头的/b/发生辅音连读；British结尾的/ʃ/与students开头的/s/发生辅音连读。"},
        {"words": "arriving for their first day", "phonetic": "/əˈraɪvɪŋ fər ðeər fɜːst deɪ/", "description": "arriving结尾的/ŋ/与for开头的/f/发生辅元连读；for弱读为/fər/；their结尾的/r/与first开头的/f/发生r连读；first结尾的/t/与day开头的/d/相邻，发生不完全爆破。"},
        {"words": "of school on Tuesday", "phonetic": "/əv skuːl ɒn ˈtjuːzdeɪ/", "description": "of弱读为/əv/，结尾的/v/与school开头的/s/发生辅音连读；school结尾的/l/与on开头的/ɒ/发生辅元连读；on结尾的/n/与Tuesday开头的/t/发生辅元连读。"},
        {"words": "were sent home over their shoes", "phonetic": "/wər sent həʊm ˈəʊvər ðeər ʃuːz/", "description": "were弱读为/wər/；sent结尾的/t/与home开头的/h/相邻，发生不完全爆破；home结尾的/m/与over开头的/əʊ/发生辅元连读；over结尾的/r/与their开头的/ð/发生r连读；their结尾的/r/与shoes开头的/ʃ/发生r连读。"},
    ],
    "sense_groups": {
...
DATA["About 30 students were turned away from Taverham high school in Norfolk due to a change in the school's uniform policy."] = {
    "connected_speech": [
        {"words": "About 30 students", "phonetic": "/əˈbaʊt ˈθɜːti ˈstjuːdənts/", "description": "About结尾的/t/与30开头的/θ/相邻，发生不完全爆破（失爆）；30结尾的/i/与students开头的/s/发生辅元连读。"},
        {"words": "were turned away from", "phonetic": "/wər tɜːnd əˈweɪ frəm/", "description": "were弱读为/wər/；turned结尾的/d/与away开头的/ə/发生辅元连读；away结尾的/eɪ/与from开头的/f/发生元辅连读；from弱读为/frəm/。"},
        {"words": "Taverham high school in Norfolk", "phonetic": "/ˈteɪvəhæm haɪ skuːl ɪn ˈnɔːfək/", "description": "Taverham结尾的/m/与high开头的/h/发生辅元连读；high结尾的/aɪ/与school开头的/s/发生元辅连读；school结尾的/l/与in开头的/ɪ/发生辅元连读；in结尾的/n/与Norfolk开头的/n/可合并或轻微延长。"},
        {"words": "due to a change in", "phonetic": "/djuː tu ə tʃeɪndʒ ɪn/", "description": "due结尾的/u/与to的/tu/发生元元连读；to弱读为/tu/；a的/ə/与change开头的/tʃ/发生辅元连读；change结尾的/dʒ/与in开头的/ɪ/发生辅元连读。"},
        {"words": "the school's uniform policy", "phonetic": "/ðə skuːlz ˈjuːnɪfɔːm ˈpɒləsi/", "description": "the弱读为/ðə/；school's结尾的/z/与uniform开头的/j/发生辅音连读；uniform结尾的/m/与policy开头的/p/发生辅音连读。"},
    ],
    "sense_groups": {
...
DATA["The head teacher said he notified parents of the updated rules in an email in June."] = {
    "connected_speech": [
        {"words": "The head teacher said", "phonetic": "/ðə hed ˈtiːtʃə sed/", "description": "the弱读为/ðə/，与head开头的/h/发生辅元连读（h可弱读省略）；head结尾的/d/与teacher开头的/t/相邻，发生不完全爆破（失爆）；teacher结尾的/ə/与said开头的/s/发生辅元连读。"},
        {"words": "he notified parents", "phonetic": "/hi ˈnəʊtɪfaɪd ˈpeərənts/", "description": "he结尾的/i/与notified开头的/n/发生辅元连读；notified结尾的/d/与parents开头的/p/相邻，发生不完全爆破（失爆）。"},
        {"words": "of the updated rules", "phonetic": "/əv ðə ʌpˈdeɪtɪd ruːlz/", "description": "of弱读为/əv/，与the的/ðə/发生辅元连读；the弱读为/ðə/，与updated开头的/ʌ/发生元元连读；updated结尾的/d/与rules开头的/r/发生辅元连读。"},
        {"words": "in an email in June", "phonetic": "/ɪn ən ˈiːmeɪl ɪn dʒuːn/", "description": "in结尾的/n/与an的/ən/发生辅元连读；an结尾的/n/与email开头的/iː/发生辅元连读；email结尾的/l/与in开头的/ɪ/发生辅元连读；in结尾的/n/与June开头的/dʒ/发生辅元连读。"},
    ],
    "sense_groups": {
...
DATA["The price of school uniforms can spark panic among families struggling with the high cost of living."] = {
    "connected_speech": [
        {"words": "The price of school uniforms", "phonetic": "/ðə praɪs əv skuːl ˈjuːnɪfɔːmz/", "description": "the弱读为/ðə/；price结尾的/s/与of开头的/ə/发生辅元连读；of弱读为/əv/，结尾的/v/与school开头的/s/发生辅音连读；school结尾的/l/与uniforms开头的/j/发生辅音连读。"},
        {"words": "can spark panic among", "phonetic": "/kæn spɑːk ˈpænɪk əˈmʌŋ/", "description": "can弱读为/kæn/，结尾的/n/与spark开头的/s/发生辅元连读；spark结尾的/k/与panic开头的/p/相邻，发生不完全爆破；panic结尾的/k/与among开头的/ə/发生辅元连读。"},
        ...
        {"words": "the high cost of living", "phonetic": "/ðə haɪ kɒst əv ˈlɪvɪŋ/", "description": "high结尾的/aɪ/与cost开头的/k/发生元辅连读；cost结尾的/t/与of开头的/ə/发生辅元连读；of弱读为/əv/，结尾的/v/与living开头的/l/发生辅音连读。"},
    ],
    "sense_groups": {
...
DATA["Nearly all British schools have uniforms. They cost parents an average of 337 pounds per year for each secondary school child."] = {
    "connected_speech": [
        {"words": "Nearly all British schools", "phonetic": "/ˈnɪəli ɔːl ˈbrɪtɪʃ skuːlz/", "description": "Nearly结尾的/i/与all开头的/ɔː/发生元元连读；all结尾的/l/与British开头的/b/发生辅元连读；British结尾的/ʃ/与schools开头的/s/发生辅音连读。"},
        {"words": "have uniforms", "phonetic": "/həv ˈjuːnɪfɔːmz/", "description": "have弱读为/həv/，结尾的/v/与uniforms开头的/j/发生辅元连读。"},
        {"words": "They cost parents", "phonetic": "/ðeɪ kɒst ˈpeərənts/", "description": "They结尾的/eɪ/与cost开头的/k/发生元辅连读；cost结尾的/t/与parents开头的/p/相邻，发生不完全爆破（失爆）。"},
        {"words": "an average of 337 pounds", "phonetic": "/ən ˈævərɪdʒ əv θriː ˈhʌndrəd ən ˈθɜːti ˈsevn paʊndz/", "description": "an结尾的/n/与average开头的/æ/发生辅元连读；average结尾的/dʒ/与of开头的/ə/发生辅元连读；of弱读为/əv/。"},
        {"words": "per year for each", "phonetic": "/pər jɪər fər iːtʃ/", "description": "per弱读为/pər/；year结尾的/r/与for开头的/f/发生r连读；for弱读为/fər/。"},
        {"words": "secondary school child", "phonetic": "/ˈsekəndəri skuːl tʃaɪld/", "description": "secondary结尾的/i/与school开头的/s/发生辅元连读；school结尾的/l/与child开头的/tʃ/发生辅音连读。"},
    ],
    "sense_groups": {
...
DATA["According to the new rules, students are required to wear smart black shoes appropriate for the workplace."] = {
    "connected_speech": [
        {"words": "According to the new rules", "phonetic": "/əˈkɔːdɪŋ tə ðə njuː ruːlz/", "description": "According结尾的/ŋ/与to开头的/t/发生辅元连读；to弱读为/tə/；the弱读为/ðə/；new结尾的/u/与rules开头的/r/发生辅元连读。"},
        {"words": "students are required to wear", "phonetic": "/ˈstjuːdənts ər rɪˈkwaɪəd tə weər/", "description": "students结尾的/s/与are开头的/ɑː/发生辅元连读；are弱读为/ər/；required结尾的/d/与to开头的/t/相邻，发生不完全爆破；to弱读为/tə/。"},
        {"words": "smart black shoes", "phonetic": "/smɑːt blæk ʃuːz/", "description": "smart结尾的/t/与black开头的/b/相邻，发生不完全爆破（失爆）；black结尾的/k/与shoes开头的/ʃ/相邻，发生不完全爆破。"},
        {"words": "appropriate for the workplace", "phonetic": "/əˈprəʊpriət fər ðə ˈwɜːkpleɪs/", "description": "appropriate结尾的/t/与for开头的/f/发生辅元连读；for弱读为/fər/；the弱读为/ðə/；workplace结尾的/s/可能省略或不发音。"},
    ],
    "sense_groups": {
...
DATA["Harris held that strengthened rules around school uniforms improved student outcomes and behavior."] = {
    "connected_speech": [
        ...
        {"words": "strengthened rules around", "phonetic": "/ˈstreŋθənd ruːlz əˈraʊnd/", "description": "strengthened结尾的/d/与rules开头的/r/发生辅元连读；rules结尾的/z/与around开头的/ə/发生辅元连读。"},
        {"words": "school uniforms", "phonetic": "/skuːl ˈjuːnɪfɔːmz/", "description": "school结尾的/l/与uniforms开头的/j/发生辅音连读。"},
        {"words": "improved student outcomes", "phonetic": "/ɪmˈpruːvd ˈstjuːdənt ˈaʊtkʌmz/", "description": "improved结尾的/d/与student开头的/s/相邻，发生不完全爆破；student结尾的/t/与outcomes开头的/aʊ/发生辅元连读。"},
...
DATA["As annual inflation climbs over 10%, many households are on tight budgets."] = {
    "connected_speech": [
        ...
        {"words": "over 10%", "phonetic": "/ˈəʊvər ten pəˈsent/", "description": "over结尾的/r/与10的/t/发生r连读。"},
        {"words": "many households are on", "phonetic": "/ˈmeni ˈhaʊshəʊldz ər ɒn/", "description": "many结尾的/i/与households开头的/h/发生辅元连读；households结尾的/z/与are开头的/ɑː/发生辅元连读；are弱读为/ər/。"},
...
DATA["Private rental prices in Britain rose 3.2% over the 12 months to July 2022, the largest jump since 2016."] = {
    "connected_speech": [
        ...
        {"words": "rose 3.2%", "phonetic": "/rəʊz θriː pɔɪnt tuː pəˈsent/", "description": "rose结尾的/z/与3.2%开头的/θ/发生辅音连读。"},
        {"words": "over the 12 months", "phonetic": "/ˈəʊvər ðə twelv mʌnθs/", "description": "over结尾的/r/与the的/ðə/发生r连读；twelve结尾的/v/与months开头的/m/发生辅音连读。"},
        {"words": "to July 2022", "phonetic": "/tə dʒuˈlaɪ twenti twenti tuː/", "description": "to弱读为/tə/，与July开头的/dʒ/发生辅元连读。"},
        {"words": "the largest jump since 2016", "phonetic": "/ðə ˈlɑːdʒɪst dʒʌmp sɪns twenti sɪkˈstiːn/", "description": "largest结尾的/t/与jump开头的/dʒ/相邻，发生不完全爆破；jump结尾的/p/与since开头的/s/发生辅元连读；since结尾的/s/与2016开头的/t/发生辅音连读。"},
    ],
    "sense_groups": {
...
DATA["Lucinda May, mum of a Taverham student, said she had to ask her parents for 65 pounds to buy her child the correct pair of shoes."] = {
    "connected_speech": [
        {"words": "Lucinda May, mum of a", "phonetic": "/luːˈsɪndə meɪ mʌm əv ə/", "description": "May结尾的/eɪ/与mum开头的/m/发生元辅连读；mum结尾的/m/与of开头的/ə/发生辅元连读；of弱读为/əv/，结尾的/v/与a的/ə/发生辅元连读。"},
        {"words": "Taverham student", "phonetic": "/ˈteɪvəhæm ˈstjuːdənt/", "description": "Taverham结尾的/m/与student开头的/s/发生辅元连读。"},
        {"words": "said she had to ask", "phonetic": "/sed ʃi həd tu ɑːsk/", "description": "said结尾的/d/与she开头的/ʃ/相邻，发生不完全爆破（失爆）；had弱读为/həd/，结尾的/d/与to开头的/t/相邻，发生不完全爆破；to弱读为/tu/。"},
        {"words": "her parents for 65 pounds", "phonetic": "/hər ˈpeərənts fər sɪksti faɪv paʊndz/", "description": "her弱读为/hər/；parents结尾的/s/与for开头的/f/发生辅元连读；for弱读为/fər/。"},
        ...
        {"words": "the correct pair of shoes", "phonetic": "/ðə kəˈrekt peər əv ʃuːz/", "description": "correct结尾的/t/与pair开头的/p/相邻，发生不完全爆破；pair结尾的/r/与of开头的/ə/发生r连读；of弱读为/əv/，结尾的/v/与shoes开头的/ʃ/发生辅音连读。"},
    ],
    "sense_groups": {
...
DATA["May said that the school's uniform policy showed the lack of regard for parents dealing with the high cost of living."] = {
    "connected_speech": [
        {"words": "May said that the school's", "phonetic": "/meɪ sed ðət ðə skuːlz/", "description": "May结尾的/eɪ/与said开头的/s/发生元辅连读；said结尾的/d/与that的/ðət/相邻，发生不完全爆破；that弱读为/ðət/；school's结尾的/z/与uniform开头的/j/发生辅音连读。"},
        {"words": "uniform policy showed", "phonetic": "/ˈjuːnɪfɔːm ˈpɒləsi ʃəʊd/", "description": "uniform结尾的/m/与policy开头的/p/发生辅音连读；policy结尾的/i/与showed开头的/ʃ/发生辅元连读。"},
        {"words": "the lack of regard", "phonetic": "/ðə læk əv rɪˈɡɑːd/", "description": "lack结尾的/k/与of开头的/ə/发生辅元连读；of弱读为/əv/，结尾的/v/与regard开头的/r/发生辅音连读。"},
        {"words": "for parents dealing with", "phonetic": "/fər ˈpeərənts ˈdiːlɪŋ wɪð/", "description": "for弱读为/fər/；parents结尾的/s/与dealing开头的/d/发生辅元连读；dealing结尾的/ŋ/与with开头的/w/发生辅元连读。"},
        {"words": "the high cost of living", "phonetic": "/ðə haɪ kɒst əv ˈlɪvɪŋ/", "description": "high结尾的/aɪ/与cost开头的/k/发生元辅连读；cost结尾的/t/与of开头的/ə/发生辅元连读；of弱读为/əv/，结尾的/v/与living开头的/l/发生辅音连读。"},
    ],
    "sense_groups": {
...
DATA["Excuse me, could you tell me where the registration office is?"] = {
    "connected_speech": [
        {"words": "Excuse me", "phonetic": "/ɪkˈskjuːz mi/", "description": "Excuse结尾的/z/与me开头的/m/发生辅音连读。"},
        ...
        {"words": "where the registration", "phonetic": "/weər ðə ˌredʒɪˈstreɪʃən/", "description": "where结尾的/r/与the的/ðə/发生r连读；the弱读为/ðə/；registration结尾的/n/与office开头的/ɒ/发生辅元连读。"},
        {"words": "office is", "phonetic": "/ˈɒfɪs ɪz/", "description": "office结尾的/s/与is开头的/ɪ/发生辅元连读。"},
    ],
    "sense_groups": {
...
DATA["I'd like to sign up for the psychology course, but it's already full."] = {
    "connected_speech": [
        ...
        {"words": "for the psychology course", "phonetic": "/fər ðə saɪˈkɒlədʒi kɔːs/", "description": "for弱读为/fər/，结尾的/r/与the的/ðə/发生r连读；the弱读为/ðə/；psychology结尾的/i/与course开头的/k/发生辅元连读。"},
        {"words": "but it's already full", "phonetic": "/bət ɪts ɔːlˈredi fʊl/", "description": "but结尾的/t/与it's开头的/ɪ/发生辅元连读；it's结尾的/s/与already开头的/ɔː/发生辅元连读；already结尾的/i/与full开头的/f/发生辅元连读。"},
    ],
    "sense_groups": {
...
DATA["The library will be closed for renovation during the summer break."] = {
    "connected_speech": [
        {"words": "The library will be closed", "phonetic": "/ðə ˈlaɪbrəri wɪl bi kləʊzd/", "description": "the弱读为/ðə/；library结尾的/i/与will开头的/w/发生辅元连读；will结尾的/l/与be开头的/b/发生辅音连读。"},
        {"words": "for renovation", "phonetic": "/fər ˌrenəˈveɪʃən/", "description": "for弱读为/fər/，结尾的/r/与renovation开头的/r/可合并或轻微延长。"},
        {"words": "during the summer break", "phonetic": "/ˈdjʊərɪŋ ðə ˈsʌmər breɪk/", "description": "during结尾的/ŋ/与the的/ðə/发生辅元连读；summer结尾的/r/与break开头的/b/发生r连读（辅元连读）。"},
    ],
    "sense_groups": {
...
DATA["Students are required to submit their essays by Friday afternoon."] = {
    "connected_speech": [
        {"words": "Students are required to", "phonetic": "/ˈstjuːdənts ər rɪˈkwaɪəd tə/", "description": "Students结尾的/s/与are开头的/ɑː/发生辅元连读；are弱读为/ər/；required结尾的/d/与to开头的/t/相邻，发生不完全爆破；to弱读为/tə/。"},
        {"words": "submit their essays", "phonetic": "/səbˈmɪt ðeər ˈeseɪz/", "description": "submit结尾的/t/与their开头的/ð/相邻，发生不完全爆破（失爆）；their结尾的/r/与essays开头的/e/发生r连读。"},
        {"words": "by Friday afternoon", "phonetic": "/baɪ ˈfraɪdeɪ ˌɑːftəˈnuːn/", "description": "by结尾的/aɪ/与Friday开头的/f/发生元辅连读；Friday结尾的/eɪ/与afternoon开头的/ɑː/发生元元连读。"},
    ],
    "sense_groups": {
...
DATA["The professor suggested we review Chapter 5 before the exam."] = {
    "connected_speech": [
        ...
        {"words": "we review Chapter 5", "phonetic": "/wi rɪˈvjuː ˈtʃæptər faɪv/", "description": "review结尾的/u/与Chapter开头的/tʃ/发生辅元连读；Chapter结尾的/r/与5的/f/发生r连读。"},
        {"words": "before the exam", "phonetic": "/bɪˈfɔːr ði ɪɡˈzæm/", "description": "before结尾的/r/与the的/ði/发生r连读；the在元音前读/ði/，与exam的/ɪ/发生元元连读。"},
    ],
    "sense_groups": {
...
DATA["Could you recommend a good restaurant near the campus?"] = {
    "connected_speech": [
        ...
        {"words": "a good restaurant", "phonetic": "/ə ɡʊd ˈrestərɒnt/", "description": "a弱读为/ə/，与good开头的/ɡ/发生辅元连读；good结尾的/d/与restaurant开头的/r/相邻，发生不完全爆破。"},
        {"words": "near the campus", "phonetic": "/nɪər ðə ˈkæmpəs/", "description": "near结尾的/r/与the的/ðə/发生r连读；the弱读为/ðə/；campus结尾的/s/可轻微弱化。"},
    ],
    "sense_groups": {
...
DATA["The bus to the city center runs every fifteen minutes on weekdays."] = {
    "connected_speech": [
        ...
        {"words": "runs every fifteen minutes", "phonetic": "/rʌnz ˈevri ˌfɪfˈtiːn ˈmɪnɪts/", "description": "runs结尾的/z/与every开头的/e/发生辅元连读；every结尾的/i/与fifteen开头的/f/发生辅元连读；fifteen结尾的/n/与minutes开头的/m/发生辅元连读。"},
        {"words": "on weekdays", "phonetic": "/ɒn ˈwiːkdeɪz/", "description": "on结尾的/n/与weekdays开头的/w/发生辅元连读。"},
    ],
    "sense_groups": {
...
DATA["I'm having trouble connecting to the university Wi-Fi network."] = {
    "connected_speech": [
        ...
        {"words": "university Wi-Fi network", "phonetic": "/ˌjuːnɪˈvɜːsɪti ˈwaɪfaɪ ˈnetwɜːk/", "description": "university结尾的/i/与Wi-Fi开头的/w/发生辅元连读；Wi-Fi结尾的/aɪ/与network开头的/n/发生元辅连读。"},
    ],
    "sense_groups": {
...
DATA["The deadline for the scholarship application has been extended to next Monday."] = {
    "connected_speech": [
        {"words": "The deadline for the scholarship", "phonetic": "/ðə ˈdedlaɪn fər ðə ˈskɒləʃɪp/", "description": "deadline结尾的/n/与for开头的/f/发生辅元连读；for弱读为/fər/；the弱读为/ðə/。"},
        {"words": "application has been extended", "phonetic": "/ˌæplɪˈkeɪʃən həz biːn ɪkˈstendɪd/", "description": "application结尾的/n/与has开头的/h/发生辅元连读；has弱读为/həz/；been结尾的/n/与extended开头的/ɪ/发生辅元连读。"},
...
DATA["Would you mind sharing your notes from yesterday's lecture?"] = {
    "connected_speech": [
        {"words": "Would you mind sharing", "phonetic": "/wʊd ju maɪnd ˈʃeərɪŋ/", "description": "would结尾的/d/与you开头的/j/发生辅元连读；you结尾的/u/与mind开头的/m/发生辅元连读；mind结尾的/d/与sharing开头的/ʃ/相邻，发生不完全爆破。"},
        {"words": "your notes from", "phonetic": "/jər nəʊts frəm/", "description": "your弱读为/jər/；notes结尾的/s/与from开头的/f/发生辅音连读；from弱读为/frəm/。"},
...
DATA["The company is looking for interns who can work at least three days a week."] = {
    "connected_speech": [
        ...
        {"words": "interns who can work", "phonetic": "/ˈɪntɜːnz huː kæn wɜːk/", "description": "interns结尾的/z/与who开头的/h/发生辅元连读；can弱读为/kæn/。"},
        {"words": "at least three days a week", "phonetic": "/ət liːst θriː deɪz ə wiːk/", "description": "at弱读为/ət/，结尾的/t/与least开头的/l/相邻，发生不完全爆破；least结尾的/t/与three开头的/θ/相邻，发生不完全爆破；days结尾的/z/与a的/ə/发生辅元连读。"},
    ],
    "sense_groups": {
...
DATA["We regret to inform you that the position has already been filled."] = {
    "connected_speech": [
        {"words": "We regret to inform you", "phonetic": "/wi rɪˈɡret tu ɪnˈfɔːm ju/", "description": "regret结尾的/t/与to开头的/t/相邻，发生不完全爆破；to弱读为/tu/，结尾的/u/与inform开头的/ɪ/发生元元连读；inform结尾的/m/与you开头的/j/发生辅元连读。"},
        {"words": "that the position", "phonetic": "/ðət ðə pəˈzɪʃən/", "description": "that弱读为/ðət/，结尾的/t/与the的/ðə/相邻，发生不完全爆破。"},
        {"words": "has already been filled", "phonetic": "/həz ɔːlˈredi biːn fɪld/", "description": "has弱读为/həz/，结尾的/z/与already开头的/ɔː/发生辅元连读；already结尾的/i/与been开头的/b/发生辅元连读；been结尾的/n/与filled开头的/f/发生辅元连读。"},
    ],
    "sense_groups": {
...
DATA["The weather forecast says it's going to rain heavily this afternoon."] = {
    "connected_speech": [
        {"words": "The weather forecast says", "phonetic": "/ðə ˈweðər ˈfɔːkɑːst sez/", "description": "weather结尾的/r/与forecast开头的/f/发生r连读（辅元连读）；forecast结尾的/t/与says开头的/s/相邻，发生不完全爆破。"},
        {"words": "it's going to rain", "phonetic": "/ɪts ˈɡəʊɪŋ tə reɪn/", "description": "it's结尾的/s/与going开头的/ɡ/发生辅音连读；going结尾的/ŋ/与to开头的/t/发生辅元连读；to弱读为/tə/。"},
        {"words": "heavily this afternoon", "phonetic": "/ˈhevɪli ðɪs ˌɑːftəˈnuːn/", "description": "heavily结尾的/i/与this开头的/ð/发生辅元连读；this结尾的/s/与afternoon开头的/ɑː/发生辅元连读。"},
    ],
    "sense_groups": {
...
DATA["I was wondering if you could help me with this math problem."] = {
    "connected_speech": [
        ...
        {"words": "this math problem", "phonetic": "/ðɪs mæθ ˈprɒbləm/", "description": "this结尾的/s/与math开头的/m/发生辅音连读；math结尾的/θ/与problem开头的/p/发生辅音连读。"},
    ],
    "sense_groups": {
...
DATA["The museum is free to enter on the first Sunday of every month."] = {
    "connected_speech": [
        {"words": "The museum is free to enter", "phonetic": "/ðə mjuːˈziːəm ɪz friː tu ˈentər/", "description": "museum结尾的/m/与is开头的/ɪ/发生辅元连读；is结尾的/z/与free开头的/f/发生辅音连读；free结尾的/i/与to的/tu/发生元元连读；to弱读为/tu/；enter结尾的/r/在美式中可与后续元音连读。"},
        {"words": "on the first Sunday", "phonetic": "/ɒn ðə fɜːst ˈsʌndeɪ/", "description": "on结尾的/n/与the的/ðə/发生辅元连读；first结尾的/t/与Sunday开头的/s/相邻，发生不完全爆破。"},
...
DATA["She decided to take a gap year before starting graduate school."] = {
    "connected_speech": [
        ...
        {"words": "a gap year", "phonetic": "/ə ɡæp jɪər/", "description": "gap结尾的/p/与year开头的/j/发生辅元连读。"},
        {"words": "before starting graduate school", "phonetic": "/bɪˈfɔːr ˈstɑːtɪŋ ˈɡrædʒuət skuːl/", "description": "before结尾的/r/与starting开头的/s/发生r连读（辅元连读）；starting结尾的/ŋ/与graduate开头的/ɡ/发生辅元连读；graduate结尾的/t/与school开头的/s/相邻，发生不完全爆破。"},
    ],
    "sense_groups": {
...
DATA["The new shopping mall has attracted a lot of customers since it opened."] = {
    "connected_speech": [
        {"words": "The new shopping mall", "phonetic": "/ðə njuː ˈʃɒpɪŋ mɔːl/", "description": "new结尾的/u/与shopping开头的/ʃ/发生辅元连读；shopping结尾的/ŋ/与mall开头的/m/发生辅元连读。"},
        {"words": "has attracted a lot of", "phonetic": "/həz əˈtræktɪd ə lɒt əv/", "description": "has弱读为/həz/，结尾的/z/与attracted开头的/ə/发生辅元连读；attracted结尾的/d/与a的/ə/发生辅元连读；lot结尾的/t/与of开头的/ə/发生辅元连读；of弱读为/əv/。"},
        {"words": "customers since it opened", "phonetic": "/ˈkʌstəmərz sɪns ɪt ˈəʊpənd/", "description": "customers结尾的/z/与since开头的/s/相邻，可合并延长；since结尾的/s/与it开头的/ɪ/发生辅元连读；it结尾的/t/与opened开头的/əʊ/发生辅元连读。"},
    ],
    "sense_groups": {
...
DATA["Please remember to bring your student ID when you come for the interview."] = {
    "connected_speech": [
        {"words": "Please remember to bring", "phonetic": "/pliːz rɪˈmembər tə brɪŋ/", "description": "remember结尾的/r/与to开头的/t/发生r连读（辅元连读）；to弱读为/tə/。"},
        {"words": "your student ID", "phonetic": "/jər ˈstjuːdənt ˌaɪ ˈdiː/", "description": "your弱读为/jər/；student结尾的/t/与ID开头的/aɪ/发生辅元连读。"},
        ...
        {"words": "the interview", "phonetic": "/ði ˈɪntəvjuː/", "description": "the在元音前读/ði/，与interview的/ɪ/发生元元连读。"},
    ],
    "sense_groups": {
...
DATA["The research project has made significant progress in the past few months."] = {
    "connected_speech": [
        {"words": "The research project", "phonetic": "/ðə rɪˈsɜːtʃ ˈprɒdʒekt/", "description": "research结尾的/tʃ/与project开头的/p/发生辅音连读。"},
        {"words": "has made significant progress", "phonetic": "/həz meɪd sɪɡˈnɪfɪkənt ˈprəʊɡres/", "description": "has弱读为/həz/，结尾的/z/与made开头的/m/发生辅音连读；made结尾的/d/与significant开头的/s/相邻，发生不完全爆破；significant结尾的/t/与progress开头的/p/相邻，发生不完全爆破。"},
        {"words": "in the past few months", "phonetic": "/ɪn ðə pɑːst fjuː mʌnθs/", "description": "past结尾的/t/与few开头的/f/相邻，发生不完全爆破（失爆）；few结尾的/u/与months开头的/m/发生辅元连读。"},
    ],
    "sense_groups": {
...
DATA["Would you prefer to have the meeting in person or online?"] = {
    "connected_speech": [
        {"words": "Would you prefer to", "phonetic": "/wʊd ju prɪˈfɜːr tə/", "description": "would结尾的/d/与you开头的/j/发生辅元连读；you结尾的/u/与prefer开头的/p/发生辅元连读；prefer结尾的/r/与to开头的/t/发生r连读；to弱读为/tə/。"},
        {"words": "have the meeting", "phonetic": "/həv ðə ˈmiːtɪŋ/", "description": "have弱读为/həv/，结尾的/v/与the的/ðə/发生辅元连读；the弱读为/ðə/。"},
        {"words": "in person or online", "phonetic": "/ɪn ˈpɜːsən ɔːr ˈɒnlaɪn/", "description": "in结尾的/n/与person开头的/p/发生辅元连读；person结尾的/n/与or开头的/ɔː/发生辅元连读；or结尾的/r/与online开头的/ɒ/发生r连读。"},
    ],
    "sense_groups": {
...
DATA["The train to London will depart from platform 7 in ten minutes."] = {
    "connected_speech": [
        ...
        {"words": "will depart from platform 7", "phonetic": "/wɪl dɪˈpɑːt frəm ˈplætfɔːm ˈsevn/", "description": "will结尾的/l/与depart开头的/d/发生辅音连读；depart结尾的/t/与from开头的/f/相邻，发生不完全爆破；from弱读为/frəm/；platform结尾的/m/与7的/s/发生辅元连读。"},
...
DATA["I'd like to exchange this shirt for a larger size, please."] = {
    "connected_speech": [
        ...
        {"words": "this shirt for", "phonetic": "/ðɪs ʃɜːt fər/", "description": "this结尾的/s/与shirt开头的/ʃ/可合并或轻微延长；shirt结尾的/t/与for开头的/f/相邻，发生不完全爆破；for弱读为/fər/。"},
        {"words": "a larger size, please", "phonetic": "/ə ˈlɑːdʒər saɪz pliːz/", "description": "larger结尾的/r/与size开头的/s/发生r连读（辅元连读）；size结尾的/z/与please开头的/p/发生辅音连读。"},
    ],
    "sense_groups": {
...
DATA["The guest speaker will talk about climate change and its effects on agriculture."] = {
    "connected_speech": [
        {"words": "The guest speaker will talk about", "phonetic": "/ðə ɡest ˈspiːkər wɪl tɔːk əˈbaʊt/", "description": "guest结尾的/t/与speaker开头的/s/相邻，发生不完全爆破；speaker结尾的/r/与will开头的/w/发生r连读；talk结尾的/k/与about开头的/ə/发生辅元连读。"},
        ...
        {"words": "on agriculture", "phonetic": "/ɒn ˈæɡrɪkʌltʃər/", "description": "on结尾的/n/与agriculture开头的/æ/发生辅元连读。"},
    ],
    "sense_groups": {
...
DATA["Could you give me a wake-up call at six o'clock tomorrow morning?"] = {
    "connected_speech": [
        ...
        {"words": "a wake-up call", "phonetic": "/ə ˈweɪkʌp kɔːl/", "description": "wake-up结尾的/p/与call开头的/k/相邻，发生不完全爆破（失爆）。"},
        {"words": "at six o'clock tomorrow morning", "phonetic": "/ət sɪks əˈklɒk təˈmɒrəʊ ˈmɔːnɪŋ/", "description": "at弱读为/ət/，结尾的/t/与six开头的/s/相邻，发生不完全爆破；six结尾的/s/与o'clock开头的/ə/发生辅元连读；o'clock结尾的/k/与tomorrow开头的/t/相邻，发生不完全爆破。"},
    ],
    "sense_groups": {
...
DATA["She's been practicing the piano for at least two hours every day."] = {
    "connected_speech": [
        {"words": "She's been practicing", "phonetic": "/ʃiz biːn ˈpræktɪsɪŋ/", "description": "She's结尾的/z/与been开头的/b/发生辅音连读；been结尾的/n/与practicing开头的/p/发生辅元连读。"},
        {"words": "the piano", "phonetic": "/ðə piˈænəʊ/", "description": "the弱读为/ðə/，与piano开头的/p/发生辅元连读。"},
        {"words": "for at least two hours", "phonetic": "/fər ət liːst tuː ˈaʊərz/", "description": "for弱读为/fər/；at弱读为/ət/，结尾的/t/与least开头的/l/相邻，发生不完全爆破；least结尾的/t/与two开头的/t/相邻，发生不完全爆破。"},
...
DATA["The flight has been delayed due to bad weather conditions at the destination."] = {
    "connected_speech": [
        {"words": "The flight has been delayed", "phonetic": "/ðə flaɪt həz biːn dɪˈleɪd/", "description": "flight结尾的/t/与has开头的/h/相邻，发生不完全爆破；has弱读为/həz/，结尾的/z/与been开头的/b/发生辅音连读；been结尾的/n/与delayed开头的/d/发生辅元连读。"},
        {"words": "due to bad weather", "phonetic": "/djuː tu bæd ˈweðər/", "description": "due结尾的/u/与to的/tu/发生元元连读；to弱读为/tu/；bad结尾的/d/与weather开头的/w/相邻，发生不完全爆破。"},
...
DATA["I'm not sure if I understood the assignment correctly. Could you clarify?"] = {
    "connected_speech": [
        {"words": "I'm not sure if I", "phonetic": "/aɪm nɒt ʃʊər ɪf aɪ/", "description": "not结尾的/t/与sure开头的/ʃ/相邻，发生不完全爆破（失爆）；sure结尾的/r/与if开头的/ɪ/在美式中发生r连读；if结尾的/f/与I开头的/aɪ/发生辅元连读。"},
...
DATA["The restaurant serves breakfast from seven to ten in the morning."] = {
    "connected_speech": [
        {"words": "The restaurant serves breakfast", "phonetic": "/ðə ˈrestərɒnt sɜːvz ˈbrekfəst/", "description": "restaurant结尾的/t/与serves开头的/s/相邻，发生不完全爆破；serves结尾的/z/与breakfast开头的/b/发生辅音连读。"},
        ...
        {"words": "in the morning", "phonetic": "/ɪn ðə ˈmɔːnɪŋ/", "description": "in结尾的/n/与the的/ðə/发生辅元连读；the弱读为/ðə/。"},
    ],
    "sense_groups": {
...
DATA["He managed to finish the project ahead of schedule despite all the difficulties."] = {
    "connected_speech": [
        ...
        {"words": "the project ahead of schedule", "phonetic": "/ðə ˈprɒdʒekt əˈhed əv ˈʃedjuːl/", "description": "project结尾的/t/与ahead开头的/ə/发生辅元连读；ahead结尾的/d/与of开头的/ə/发生辅元连读；of弱读为/əv/，结尾的/v/与schedule开头的/ʃ/发生辅音连读。"},
        {"words": "despite all the difficulties", "phonetic": "/dɪˈspaɪt ɔːl ðə ˈdɪfɪkəltiz/", "description": "despite结尾的/t/与all开头的/ɔː/发生辅元连读；all结尾的/l/与the的/ðə/发生辅元连读。"},
    ],
    "sense_groups": {
...
DATA["Would it be possible to reschedule our appointment for next Tuesday?"] = {
    "connected_speech": [
        {"words": "Would it be possible", "phonetic": "/wʊd ɪt bi ˈpɒsɪbəl/", "description": "would结尾的/d/与it开头的/ɪ/发生辅元连读；it结尾的/t/与be开头的/b/相邻，发生不完全爆破（失爆）。"},
        {"words": "to reschedule our appointment", "phonetic": "/tə ˌriːˈʃedjuːl aʊər əˈpɔɪntmənt/", "description": "to弱读为/tə/，与reschedule开头的/r/发生辅元连读；reschedule结尾的/l/与our的/aʊə/发生辅元连读；our结尾的/r/与appointment开头的/ə/发生r连读。"},
        {"words": "for next Tuesday", "phonetic": "/fər nekst ˈtjuːzdeɪ/", "description": "for弱读为/fər/；next结尾的/t/与Tuesday开头的/t/相邻，发生不完全爆破。"},
    ],
    "sense_groups": {
...
DATA["The unprecedented economic growth has brought both opportunities and challenges."] = {
    "connected_speech": [
        {"words": "The unprecedented economic growth", "phonetic": "/ði ʌnˈpresɪdəntɪd ˌiːkəˈnɒmɪk ɡrəʊθ/", "description": "the在元音前读/ði/，与unprecedented的/ʌ/发生元元连读；unprecedented结尾的/d/与economic开头的/iː/发生辅元连读；economic结尾的/k/与growth开头的/ɡ/相邻，发生不完全爆破。"},
        {"words": "has brought both", "phonetic": "/həz brɔːt bəʊθ/", "description": "has弱读为/həz/，结尾的/z/与brought开头的/b/发生辅音连读；brought结尾的/t/与both开头的/b/相邻，发生不完全爆破（失爆）。"},
        {"words": "opportunities and challenges", "phonetic": "/ˌɒpəˈtjuːnɪtiz ən ˈtʃælɪndʒɪz/", "description": "opportunities结尾的/z/与and的/ən/发生辅元连读；and弱读为/ən/，结尾的/n/与challenges开头的/tʃ/发生辅元连读。"},
    ],
    "sense_groups": {
...
DATA["Scientists have discovered a potential link between sleep deprivation and memory loss."] = {
    "connected_speech": [
        {"words": "Scientists have discovered", "phonetic": "/ˈsaɪəntɪsts həv dɪˈskʌvəd/", "description": "Scientists结尾的/s/与have开头的/h/发生辅元连读；have弱读为/həv/，结尾的/v/与discovered开头的/d/发生辅音连读。"},
        ...
        {"words": "between sleep deprivation", "phonetic": "/bɪˈtwiːn sliːp ˌdeprɪˈveɪʃən/", "description": "between结尾的/n/与sleep开头的/s/发生辅元连读；sleep结尾的/p/与deprivation开头的/d/相邻，发生不完全爆破。"},
        {"words": "and memory loss", "phonetic": "/ən ˈmeməri lɒs/", "description": "and弱读为/ən/，结尾的/n/与memory开头的/m/发生辅元连读；memory结尾的/i/与loss开头的/l/发生辅元连读。"},
    ],
    "sense_groups": {
...
DATA["The government has implemented a series of measures to tackle air pollution."] = {
    "connected_speech": [
        ...
        {"words": "a series of measures", "phonetic": "/ə ˈsɪəriːz əv ˈmeʒərz/", "description": "series结尾的/z/与of开头的/ə/发生辅元连读；of弱读为/əv/，结尾的/v/与measures开头的/m/发生辅音连读。"},
        {"words": "to tackle air pollution", "phonetic": "/tə ˈtækəl eər pəˈluːʃən/", "description": "to弱读为/tə/，与tackle开头的/t/发生辅元连读；tackle结尾的/l/与air开头的/eə/发生辅元连读；air结尾的/r/与pollution开头的/p/发生r连读。"},
    ],
    "sense_groups": {
...
DATA["It is essential that we take immediate action to preserve endangered species."] = {
    "connected_speech": [
        ...
        {"words": "take immediate action", "phonetic": "/teɪk ɪˈmiːdiət ˈækʃən/", "description": "take结尾的/k/与immediate开头的/ɪ/发生辅元连读；immediate结尾的/t/与action开头的/æ/发生辅元连读。"},
        {"words": "to preserve endangered species", "phonetic": "/tə prɪˈzɜːv ɪnˈdeɪndʒəd ˈspiːʃiːz/", "description": "to弱读为/tə/，与preserve开头的/p/发生辅元连读；preserve结尾的/v/与endangered开头的/ɪ/发生辅元连读；endangered结尾的/d/与species开头的/s/相邻，发生不完全爆破。"},
    ],
    "sense_groups": {
...
DATA["The professor emphasized the importance of critical thinking in academic research."] = {
    "connected_speech": [
        ...
        {"words": "the importance of critical thinking", "phonetic": "/ði ɪmˈpɔːtəns əv ˈkrɪtɪkəl ˈθɪŋkɪŋ/", "description": "the在元音前读/ði/，与importance的/ɪ/发生元元连读；importance结尾的/s/与of开头的/ə/发生辅元连读；of弱读为/əv/；critical结尾的/l/与thinking开头的/θ/发生辅音连读。"},
        {"words": "in academic research", "phonetic": "/ɪn ˌækəˈdemɪk rɪˈsɜːtʃ/", "description": "in结尾的/n/与academic开头的/æ/发生辅元连读；academic结尾的/k/与research开头的/r/发生辅元连读。"},
    ],
    "sense_groups": {
...
DATA["The advancement of artificial intelligence has revolutionized many industries."] = {
    "connected_speech": [
        {"words": "The advancement of artificial", "phonetic": "/ði ədˈvɑːnsmənt əv ˌɑːtɪˈfɪʃəl/", "description": "the在元音前读/ði/；advancement结尾的/t/与of开头的/ə/发生辅元连读；of弱读为/əv/，结尾的/v/与artificial开头的/ɑː/发生辅元连读。"},
        {"words": "intelligence has revolutionized", "phonetic": "/ɪnˈtelɪdʒəns həz ˌrevəˈluːʃənaɪzd/", "description": "intelligence结尾的/s/与has开头的/h/发生辅元连读；has弱读为/həz/，结尾的/z/与revolutionized开头的/r/发生辅音连读。"},
...
DATA["Many young professionals are choosing to work remotely rather than in traditional offices."] = {
    "connected_speech": [
        ...
        {"words": "are choosing to work remotely", "phonetic": "/ər ˈtʃuːzɪŋ tə wɜːk rɪˈməʊtli/", "description": "are弱读为/ər/；choosing结尾的/ŋ/与to开头的/t/发生辅元连读；to弱读为/tə/；work结尾的/k/与remotely开头的/r/发生辅元连读。"},
        {"words": "rather than in traditional offices", "phonetic": "/ˈrɑːðər ðən ɪn trəˈdɪʃənəl ˈɒfɪsɪz/", "description": "rather结尾的/r/与than的/ðən/发生r连读；than弱读为/ðən/；in结尾的/n/与traditional开头的/t/发生辅元连读；traditional结尾的/l/与offices开头的/ɒ/发生辅元连读。"},
    ],
    "sense_groups": {
...
DATA["The documentary highlighted the devastating impact of plastic waste on marine life."] = {
    "connected_speech": [
        {"words": "The documentary highlighted", "phonetic": "/ðə ˌdɒkjuˈmentəri ˈhaɪlaɪtɪd/", "description": "documentary结尾的/i/与highlighted开头的/h/发生辅元连读。"},
        ...
        {"words": "on marine life", "phonetic": "/ɒn məˈriːn laɪf/", "description": "on结尾的/n/与marine开头的/m/发生辅元连读；marine结尾的/n/与life开头的/l/发生辅元连读。"},
    ],
    "sense_groups": {
...
DATA["Effective communication skills are indispensable in today's competitive job market."] = {
    "connected_speech": [
        {"words": "Effective communication skills", "phonetic": "/ɪˈfektɪv kəˌmjuːnɪˈkeɪʃən skɪlz/", "description": "Effective结尾的/v/与communication开头的/k/发生辅音连读；communication结尾的/n/与skills开头的/s/发生辅元连读。"},
        {"words": "are indispensable", "phonetic": "/ər ˌɪndɪˈspensəbəl/", "description": "are弱读为/ər/，结尾的/r/与indispensable开头的/ɪ/发生r连读。"},
        {"words": "in today's competitive job market", "phonetic": "/ɪn təˈdeɪz kəmˈpetɪtɪv dʒɒb ˈmɑːkɪt/", "description": "in结尾的/n/与today's开头的/t/发生辅元连读；today's结尾的/z/与competitive开头的/k/发生辅音连读；competitive结尾的/v/与job开头的/dʒ/发生辅音连读；job结尾的/b/与market开头的/m/相邻，发生不完全爆破。"},
    ],
    "sense_groups": {
...
DATA["The recent survey indicates that public awareness of mental health has increased significantly."] = {
    "connected_speech": [
        {"words": "The recent survey indicates", "phonetic": "/ðə ˈriːsənt ˈsɜːveɪ ˈɪndɪkeɪts/", "description": "recent结尾的/t/与survey开头的/s/相邻，发生不完全爆破；survey结尾的/eɪ/与indicates开头的/ɪ/发生元元连读。"},
        {"words": "that public awareness", "phonetic": "/ðət ˈpʌblɪk əˈweənəs/", "description": "that弱读为/ðət/，结尾的/t/与public开头的/p/相邻，发生不完全爆破；public结尾的/k/与awareness开头的/ə/发生辅元连读。"},
        ...
        {"words": "has increased significantly", "phonetic": "/həz ɪnˈkriːst sɪɡˈnɪfɪkəntli/", "description": "has弱读为/həz/，结尾的/z/与increased开头的/ɪ/发生辅元连读；increased结尾的/t/与significantly开头的/s/相邻，发生不完全爆破。"},
    ],
    "sense_groups": {
...
DATA["The transition to renewable energy sources is crucial for sustainable development."] = {
    "connected_speech": [
        {"words": "The transition to renewable", "phonetic": "/ðə trænˈzɪʃən tə rɪˈnjuːəbəl/", "description": "transition结尾的/n/与to开头的/t/发生辅元连读；to弱读为/tə/，结尾的/ə/与renewable开头的/r/发生辅元连读。"},
        {"words": "energy sources is crucial", "phonetic": "/ˈenədʒi ˈsɔːsɪz ɪz ˈkruːʃəl/", "description": "energy结尾的/i/与sources开头的/s/发生辅元连读；sources结尾的/z/与is开头的/ɪ/发生辅元连读。"},
...
DATA["A comprehensive understanding of cultural differences facilitates international collaboration."] = {
    "connected_speech": [
        {"words": "A comprehensive understanding", "phonetic": "/ə ˌkɒmprɪˈhensɪv ˌʌndəˈstændɪŋ/", "description": "comprehensive结尾的/v/与understanding开头的/ʌ/发生辅元连读。"},
...
DATA["The committee will evaluate the proposal based on its feasibility and potential impact."] = {
    "connected_speech": [
        ...
        {"words": "the proposal based on", "phonetic": "/ðə prəˈpəʊzəl beɪst ɒn/", "description": "proposal结尾的/l/与based开头的/b/发生辅音连读；based结尾的/t/与on开头的/ɒ/发生辅元连读。"},
        {"words": "its feasibility and", "phonetic": "/ɪts ˌfiːzɪˈbɪlɪti ən/", "description": "its结尾的/s/与feasibility开头的/f/发生辅音连读；feasibility结尾的/i/与and的/ən/发生辅元连读；and弱读为/ən/。"},
...
DATA["Innovation has always been the driving force behind technological breakthroughs."] = {
    "connected_speech": [
        {"words": "Innovation has always been", "phonetic": "/ˌɪnəˈveɪʃən həz ˈɔːlweɪz biːn/", "description": "Innovation结尾的/n/与has开头的/h/发生辅元连读；has弱读为/həz/，结尾的/z/与always开头的/ɔː/发生辅元连读；always结尾的/z/与been开头的/b/发生辅音连读。"},
        {"words": "the driving force", "phonetic": "/ðə ˈdraɪvɪŋ fɔːs/", "description": "driving结尾的/ŋ/与force开头的/f/发生辅元连读。"},
        {"words": "behind technological breakthroughs", "phonetic": "/bɪˈhaɪnd ˌteknəˈlɒdʒɪkəl ˈbreɪkθruːz/", "description": "behind结尾的/d/与technological开头的/t/相邻，发生不完全爆破；technological结尾的/l/与breakthroughs开头的/b/发生辅音连读。"},
    ],
    "sense_groups": {
...
DATA["The percentage of elderly population is projected to double by the year 2050."] = {
    "connected_speech": [
        {"words": "The percentage of elderly population", "phonetic": "/ðə pəˈsentɪdʒ əv ˈeldəli ˌpɒpjuˈleɪʃən/", "description": "percentage结尾的/dʒ/与of开头的/ə/发生辅元连读；of弱读为/əv/，结尾的/v/与elderly开头的/e/发生辅元连读；elderly结尾的/i/与population开头的/p/发生辅元连读。"},
        ...
        {"words": "by the year 2050", "phonetic": "/baɪ ðə jɪər twenti ˈfɪfti/", "description": "by结尾的/aɪ/与the的/ðə/发生元辅连读；year结尾的/r/与2050的/t/发生r连读。"},
    ],
    "sense_groups": {
...
DATA["Reading extensively can significantly enhance your vocabulary and writing proficiency."] = {
    "connected_speech": [
        {"words": "Reading extensively can significantly", "phonetic": "/ˈriːdɪŋ ɪkˈstensɪvli kæn sɪɡˈnɪfɪkəntli/", "description": "Reading结尾的/ŋ/与extensively开头的/ɪ/发生辅元连读；extensively结尾的/i/与can开头的/k/发生辅元连读；can弱读为/kæn/。"},
        {"words": "enhance your vocabulary", "phonetic": "/ɪnˈhɑːns jər vəˈkæbjuləri/", "description": "enhance结尾的/s/与your的/jər/发生辅音连读；your弱读为/jər/。"},
...
DATA["The negotiation reached a deadlock as neither party was willing to compromise."] = {
    "connected_speech": [
        {"words": "The negotiation reached", "phonetic": "/ðə nɪˌɡəʊʃiˈeɪʃən riːtʃt/", "description": "negotiation结尾的/n/与reached开头的/r/发生辅元连读。"},
        {"words": "a deadlock as neither party", "phonetic": "/ə ˈdedlɒk əz ˈnaɪðər ˈpɑːti/", "description": "deadlock结尾的/k/与as开头的/ə/发生辅元连读；as弱读为/əz/；neither结尾的/r/与party开头的/p/发生r连读。"},
        {"words": "was willing to compromise", "phonetic": "/wəz ˈwɪlɪŋ tə ˈkɒmprəmaɪz/", "description": "was弱读为/wəz/，结尾的/z/与willing开头的/w/发生辅音连读；willing结尾的/ŋ/与to开头的/t/发生辅元连读；to弱读为/tə/。"},
    ],
    "sense_groups": {
...
DATA["Social media has fundamentally transformed the way people interact with one another."] = {
    "connected_speech": [
        {"words": "Social media has fundamentally", "phonetic": "/ˈsəʊʃəl ˈmiːdiə həz ˌfʌndəˈmentəli/", "description": "media结尾的/ə/与has开头的/h/发生元辅连读；has弱读为/həz/，结尾的/z/与fundamentally开头的/f/发生辅音连读。"},
        {"words": "transformed the way", "phonetic": "/trænsˈfɔːmd ðə weɪ/", "description": "transformed结尾的/d/与the的/ðə/相邻，发生不完全爆破；the弱读为/ðə/。"},
        {"words": "people interact with", "phonetic": "/ˈpiːpəl ˌɪntərˈækt wɪð/", "description": "people结尾的/l/与interact开头的/ɪ/发生辅元连读；interact结尾的/t/与with开头的/w/相邻，发生不完全爆破。"},
...
DATA["The scholarship is awarded to students who demonstrate exceptional academic performance."] = {
    "connected_speech": [
        {"words": "The scholarship is awarded", "phonetic": "/ðə ˈskɒləʃɪp ɪz əˈwɔːdɪd/", "description": "scholarship结尾的/p/与is开头的/ɪ/发生辅元连读；is结尾的/z/与awarded开头的/ə/发生辅元连读。"},
        {"words": "to students who demonstrate", "phonetic": "/tə ˈstjuːdənts huː ˈdemənstreɪt/", "description": "to弱读为/tə/，与students开头的/s/发生辅元连读；students结尾的/s/与who开头的/h/发生辅元连读；who结尾的/u/与demonstrate开头的/d/发生辅元连读。"},
        {"words": "exceptional academic performance", "phonetic": "/ɪkˈsepʃənəl ˌækəˈdemɪk pəˈfɔːməns/", "description": "exceptional结尾的/l/与academic开头的/æ/发生辅元连读；academic结尾的/k/与performance开头的/p/相邻，发生不完全爆破。"},
    ],
    "sense_groups": {
...
DATA["Addressing income inequality requires coordinated efforts from both government and society."] = {
    "connected_speech": [
        {"words": "Addressing income inequality", "phonetic": "/əˈdresɪŋ ˈɪnkʌm ˌɪnɪˈkwɒlɪti/", "description": "Addressing结尾的/ŋ/与income开头的/ɪ/发生辅元连读；income结尾的/m/与inequality开头的/ɪ/发生辅元连读。"},
        {"words": "requires coordinated efforts", "phonetic": "/rɪˈkwaɪərz kəʊˈɔːdɪneɪtɪd ˈefəts/", "description": "requires结尾的/z/与coordinated开头的/k/发生辅音连读；coordinated结尾的/d/与efforts开头的/e/发生辅元连读。"},
        {"words": "from both government and society", "phonetic": "/frəm bəʊθ ˈɡʌvənmənt ən səˈsaɪəti/", "description": "from弱读为/frəm/，结尾的/m/与both开头的/b/发生辅元连读；both结尾的/θ/与government开头的/ɡ/发生辅音连读；government结尾的/t/与and的/ən/发生辅元连读；and弱读为/ən/。"},
    ],
    "sense_groups": {
